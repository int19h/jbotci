...
class GroupedForethoughtBridiConnectionSyntax(_SyntaxNode):
    ...
    def __new__(cls, tense_modals: Sequence[TenseModalSyntax], ke: WithFreeModifiers[Token, FreeModifierSyntax], inner: ForethoughtBridiConnectionSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> GroupedForethoughtBridiConnectionSyntax:
        return cls._from_fields((tense_modals, ke, inner, kehe))
    def __init__(self, tense_modals: Sequence[TenseModalSyntax], ke: WithFreeModifiers[Token, FreeModifierSyntax], inner: ForethoughtBridiConnectionSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def tense_modals(self) -> tuple[TenseModalSyntax, ...]:
        'The source-ordered tag sequence before KE.'
        return cast(tuple[TenseModalSyntax, ...], self._field(0))
    @property
    def ke(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The `Ke` cmavo marker.'
        return cast(WithFreeModifiers[Token, FreeModifierSyntax], self._field(1))
...
class GroupedForethoughtBridiConnectionWithoutTailTermsSyntax(_SyntaxNode):
    ...
    _schema_id = 120
    __match_args__ = ('tense_modals', 'ke', 'inner', 'kehe')
    def __new__(cls, tense_modals: Sequence[TenseModalSyntax], ke: WithFreeModifiers[Token, FreeModifierSyntax], inner: ForethoughtBridiConnectionWithoutTailTermsSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> GroupedForethoughtBridiConnectionWithoutTailTermsSyntax:
        return cls._from_fields((tense_modals, ke, inner, kehe))
    def __init__(self, tense_modals: Sequence[TenseModalSyntax], ke: WithFreeModifiers[Token, FreeModifierSyntax], inner: ForethoughtBridiConnectionWithoutTailTermsSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def tense_modals(self) -> tuple[TenseModalSyntax, ...]:
        'The source-ordered tag sequence before KE.'
...
class PeheTermsetOperandSyntaxStagBoundTermConnection(_SyntaxNode):
    ...
    def __init__(self, stag_bound_term_connection: StagBoundTermConnectionSyntax) -> None:
        pass
    @property
    def stag_bound_term_connection(self) -> StagBoundTermConnectionSyntax:
        'Uses the `stag_bound_term_connection` product form, whose payload preserves `leading_term` and `continuations`.'
        return cast(StagBoundTermConnectionSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
...
class SimpleTermSyntaxElidedNaheFihoTagTerm(_SyntaxNode):
    ...
    def __init__(self, elided_nahe_fiho_tag_term: ElidedNaheFihoTagTermSyntax) -> None:
        pass
    @property
    def elided_nahe_fiho_tag_term(self) -> ElidedNaheFihoTagTermSyntax:
        'Uses the `elided_nahe_fiho_tag_term` product form for the sourced final tag-term fragment.'
        return cast(ElidedNaheFihoTagTermSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SimpleTermSyntaxElidedNaheFihoTagTerm is final')
...
class BoundTermSyntaxElidedNaheFihoTagTerm(_SyntaxNode):
    ...
    def elided_nahe_fiho_tag_term(self) -> ElidedNaheFihoTagTermSyntax:
        ...
        return cast(ElidedNaheFihoTagTermSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundTermSyntaxElidedNaheFihoTagTerm is final')
...
class StagBoundTermConnectionSyntax(_SyntaxNode):
    ...
    def __new__(cls, leading_term: SimpleTermSyntax, continuations: Sequence[StagBoundTermContinuationSyntax]) -> StagBoundTermConnectionSyntax:
        return cls._from_fields((leading_term, continuations))
    def __init__(self, leading_term: SimpleTermSyntax, continuations: Sequence[StagBoundTermContinuationSyntax]) -> None:
        pass
    @property
    ...
    def continuations(self) -> tuple[StagBoundTermContinuationSyntax, ...]:
        ...
        return cast(tuple[StagBoundTermContinuationSyntax, ...], self._field(1))
    def __init_subclass__(cls) -> None:
...
class StagBoundTermContinuationSyntax(_SyntaxNode):
    ...
    def __new__(cls, connective: BoundTermConnectiveSyntax, tense_modal: TenseModalSyntax, bo: WithFreeModifiers[Token, FreeModifierSyntax], trailing_term: SimpleTermSyntax) -> StagBoundTermContinuationSyntax:
        return cls._from_fields((connective, tense_modal, bo, trailing_term))
    def __init__(self, connective: BoundTermConnectiveSyntax, tense_modal: TenseModalSyntax, bo: WithFreeModifiers[Token, FreeModifierSyntax], trailing_term: SimpleTermSyntax) -> None:
        pass
    @property
    def connective(self) -> BoundTermConnectiveSyntax:
        'The connective joining the adjacent simple terms.'
        return cast(BoundTermConnectiveSyntax, self._field(0))
    @property
...
class ConnectedTermSyntax(_SyntaxNode):
    ...
    def __new__(cls, leading_term: BoundTermSyntax, continuations: Sequence[ConnectedTermContinuationSyntax]) -> ConnectedTermSyntax:
        return cls._from_fields((leading_term, continuations))
    def __init__(self, leading_term: BoundTermSyntax, continuations: Sequence[ConnectedTermContinuationSyntax]) -> None:
        pass
    @property
    def leading_term(self) -> BoundTermSyntax:
        'The shared leading term child syntax node.'
        return cast(BoundTermSyntax, self._field(0))
    @property
...
class ConnectedTermContinuationSyntax(_SyntaxNode):
    ...
    def __init__(self, connective: ConnectedTermConnectiveSyntax, trailing_term: BoundTermSyntax) -> None:
        pass
    @property
    ...
    def trailing_term(self) -> BoundTermSyntax:
        'The shared trailing term child syntax node.'
        return cast(BoundTermSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
...
class GroupedForethoughtBridiTermEscapeSyntax(_SyntaxNode):
    ...
    def __new__(cls, outer_ke: WithFreeModifiers[Token, FreeModifierSyntax], tense_modals: Sequence[TenseModalSyntax], inner_ke: WithFreeModifiers[Token, FreeModifierSyntax], gek: ModalForethoughtConnectiveSyntax) -> GroupedForethoughtBridiTermEscapeSyntax:
        return cls._from_fields((outer_ke, tense_modals, inner_ke, gek))
    def __init__(self, outer_ke: WithFreeModifiers[Token, FreeModifierSyntax], tense_modals: Sequence[TenseModalSyntax], inner_ke: WithFreeModifiers[Token, FreeModifierSyntax], gek: ModalForethoughtConnectiveSyntax) -> None:
        pass
    @property
    ...
    def tense_modals(self) -> tuple[TenseModalSyntax, ...]:
        ...
        return cast(tuple[TenseModalSyntax, ...], self._field(1))
    @property
    ...
    def gek(self) -> ModalForethoughtConnectiveSyntax:
        ...
        return cast(ModalForethoughtConnectiveSyntax, self._field(3))
    def __init_subclass__(cls) -> None:
        raise TypeError('GroupedForethoughtBridiTermEscapeSyntax is final')
...
class ElidedNaheFihoTagTermSyntax(_SyntaxNode):
    ...
    def sumti(self) -> TaggedOrElidedSumtiSyntax:
        ...
        return cast(TaggedOrElidedSumtiSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ElidedNaheFihoTagTermSyntax is final')
...
class BoundSumtiTailSyntax(_SyntaxNode):
    ...
    def __new__(cls, connective: SumtiConnectiveSyntax, tense_modal: TenseModalSyntax | None, bo: WithFreeModifiers[Token, FreeModifierSyntax], trailing_sumti: SumtiBoundSyntax) -> BoundSumtiTailSyntax:
        return cls._from_fields((connective, tense_modal, bo, trailing_sumti))
    def __init__(self, connective: SumtiConnectiveSyntax, tense_modal: TenseModalSyntax | None, bo: WithFreeModifiers[Token, FreeModifierSyntax], trailing_sumti: SumtiBoundSyntax) -> None:
        pass
    @property
    def connective(self) -> SumtiConnectiveSyntax:
        'The shared connective child syntax node.'
        return cast(SumtiConnectiveSyntax, self._field(0))
    @property
    def tense_modal(self) -> TenseModalSyntax | None:
        'The optional tense modal component.'
        return cast(TenseModalSyntax | None, self._field(1))
...
class SumtiAfterthoughtTailSyntax(_SyntaxNode):
    ...
    def __init__(self, connective: SumtiConnectiveSyntax, sumti: SumtiBoundSyntax) -> None:
        pass
    @property
    def connective(self) -> SumtiConnectiveSyntax:
...
class GroupedSumtiTailSyntax(_SyntaxNode):
    ...
    def __new__(cls, connective: SumtiConnectiveSyntax, tense_modal: TenseModalSyntax | None, ke: WithFreeModifiers[Token, FreeModifierSyntax], inner_sumti: SumtiSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> GroupedSumtiTailSyntax:
        return cls._from_fields((connective, tense_modal, ke, inner_sumti, kehe))
    def __init__(self, connective: SumtiConnectiveSyntax, tense_modal: TenseModalSyntax | None, ke: WithFreeModifiers[Token, FreeModifierSyntax], inner_sumti: SumtiSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def connective(self) -> SumtiConnectiveSyntax:
...
class VuhoSumtiAttachmentTailSyntaxExperimentalVuhoScopedSumtiAttachmentTail(_SyntaxNode):
    ...
    def __init__(self, experimental_vuho_scoped_sumti_attachment_tail: ExperimentalVuhoScopedSumtiAttachmentTailSyntax) -> None:
        pass
    @property
    def experimental_vuho_scoped_sumti_attachment_tail(self) -> ExperimentalVuhoScopedSumtiAttachmentTailSyntax:
        'Experimental VUhO-scoped continuation with required relatives and one required sumti continuation, reachable only immediately before explicit LUhU.'
        return cast(ExperimentalVuhoScopedSumtiAttachmentTailSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('VuhoSumtiAttachmentTailSyntaxExperimentalVuhoScopedSumtiAttachmentTail is final')
...
class VuhoSumtiAttachmentTailSyntaxExperimentalBareVuhoSumtiAttachmentTail(_SyntaxNode):
    ...
    def __init__(self, experimental_bare_vuho_sumti_attachment_tail: ExperimentalBareVuhoSumtiAttachmentTailSyntax) -> None:
        pass
    @property
    def experimental_bare_vuho_sumti_attachment_tail(self) -> ExperimentalBareVuhoSumtiAttachmentTailSyntax:
        'Experimental bare VUhO attachment.'
        return cast(ExperimentalBareVuhoSumtiAttachmentTailSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('VuhoSumtiAttachmentTailSyntaxExperimentalBareVuhoSumtiAttachmentTail is final')
...
class VuhoRelativeSumtiAttachmentTailSyntax(_SyntaxNode):
    ...
    def __init__(self, vuho: WithFreeModifiers[Token, FreeModifierSyntax], relative_clauses: RelativeClauseListSyntax) -> None:
        pass
    @property
...
class ExperimentalVuhoScopedSumtiAttachmentTailSyntax(_SyntaxNode):
    ...
    def __new__(cls, vuho: WithFreeModifiers[Token, FreeModifierSyntax], relative_clauses: RelativeClauseListSyntax, sumti_connection: SumtiConnectionTailSyntax) -> ExperimentalVuhoScopedSumtiAttachmentTailSyntax:
        return cls._from_fields((vuho, relative_clauses, sumti_connection))
    def __init__(self, vuho: WithFreeModifiers[Token, FreeModifierSyntax], relative_clauses: RelativeClauseListSyntax, sumti_connection: SumtiConnectionTailSyntax) -> None:
        pass
    @property
    def vuho(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
    ...
    def sumti_connection(self) -> SumtiConnectionTailSyntax:
        ...
        return cast(SumtiConnectionTailSyntax, self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ExperimentalVuhoScopedSumtiAttachmentTailSyntax is final')
...
class ExperimentalBareVuhoSumtiAttachmentTailSyntax(_SyntaxNode):
    ...
    def __init__(self, vuho: WithFreeModifiers[Token, FreeModifierSyntax]) -> None:
        pass
    @property
    def vuho(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ExperimentalBareVuhoSumtiAttachmentTailSyntax is final')
...
class SumtiConnectionTailSyntax(_SyntaxNode):
    ...
    def __new__(cls, connective: SumtiConnectiveSyntax, sumti: SumtiSyntax) -> SumtiConnectionTailSyntax:
        return cls._from_fields((connective, sumti))
    def __init__(self, connective: SumtiConnectiveSyntax, sumti: SumtiSyntax) -> None:
        pass
    @property
    def connective(self) -> SumtiConnectiveSyntax:
...
class PaRunQuantifierSyntax(_SyntaxNode):
    ...
    def __new__(cls, number: NumberWordsSyntax, boi: WithFreeModifiers[Token, FreeModifierSyntax] | None, free_modifiers: Sequence[FreeModifierSyntax]) -> PaRunQuantifierSyntax:
        return cls._from_fields((number, boi, free_modifiers))
    def __init__(self, number: NumberWordsSyntax, boi: WithFreeModifiers[Token, FreeModifierSyntax] | None, free_modifiers: Sequence[FreeModifierSyntax]) -> None:
        pass
    @property
...
class MeksoOperatorSyntax(_SyntaxNode):
    ...
    def __init__(self, leading_operator: InnerMeksoOperatorSyntax, continuations: Sequence[MeksoOperatorContinuationSyntax]) -> None:
        pass
    @property
    def leading_operator(self) -> InnerMeksoOperatorSyntax:
        'The operator_1-width operator at the start of the chain.'
        return cast(InnerMeksoOperatorSyntax, self._field(0))
    @property
    def continuations(self) -> tuple[MeksoOperatorContinuationSyntax, ...]:
        'Freely interleaved afterthought and KE-grouped continuations.'
        return cast(tuple[MeksoOperatorContinuationSyntax, ...], self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('MeksoOperatorSyntax is final')
...
class MeksoOperatorContinuationSyntaxAfterthoughtMeksoOperatorContinuation(_SyntaxNode):
    ...
    def __init__(self, afterthought_mekso_operator_continuation: AfterthoughtMeksoOperatorContinuationSyntax) -> None:
        pass
    @property
    def afterthought_mekso_operator_continuation(self) -> AfterthoughtMeksoOperatorContinuationSyntax:
        'A joik/jek continuation followed by an operator_1-width operator.'
        return cast(AfterthoughtMeksoOperatorContinuationSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('MeksoOperatorContinuationSyntaxAfterthoughtMeksoOperatorContinuation is final')
...
class MeksoOperatorContinuationSyntaxGroupedMeksoOperatorContinuation(_SyntaxNode):
    ...
    def __init__(self, grouped_mekso_operator_continuation: GroupedMeksoOperatorContinuationSyntax) -> None:
        pass
    @property
    def grouped_mekso_operator_continuation(self) -> GroupedMeksoOperatorContinuationSyntax:
        'A joik-only continuation containing a full KE-grouped operator.'
        return cast(GroupedMeksoOperatorContinuationSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('MeksoOperatorContinuationSyntaxGroupedMeksoOperatorContinuation is final')
...
class AfterthoughtMeksoOperatorContinuationSyntax(_SyntaxNode):
    ...
    def __init__(self, connective: StandardStatementConnectiveSyntax, trailing_operator: InnerMeksoOperatorSyntax) -> None:
        pass
    @property
    ...
    def trailing_operator(self) -> InnerMeksoOperatorSyntax:
        ...
        return cast(InnerMeksoOperatorSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
...
class GroupedMeksoOperatorContinuationSyntax(_SyntaxNode):
    ...
    def __new__(cls, connective: JoikConnectiveSyntax, tense_modal: TenseModalSyntax | None, ke: WithFreeModifiers[Token, FreeModifierSyntax], inner_operator: MeksoOperatorSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> GroupedMeksoOperatorContinuationSyntax:
        return cls._from_fields((connective, tense_modal, ke, inner_operator, kehe))
    def __init__(self, connective: JoikConnectiveSyntax, tense_modal: TenseModalSyntax | None, ke: WithFreeModifiers[Token, FreeModifierSyntax], inner_operator: MeksoOperatorSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    ...
    def kehe(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(4))
    def __init_subclass__(cls) -> None:
        raise TypeError('GroupedMeksoOperatorContinuationSyntax is final')
...
class InnerMeksoOperatorSyntaxForethoughtMeksoOperator(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('InnerMeksoOperatorSyntaxForethoughtMeksoOperator is final')
...
class InnerMeksoOperatorSyntaxBoundMeksoOperator(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('InnerMeksoOperatorSyntaxBoundMeksoOperator is final')
...
class InnerMeksoOperatorSyntaxSimpleMeksoOperator(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('InnerMeksoOperatorSyntaxSimpleMeksoOperator is final')
...
class BoundMeksoOperatorSyntax(_SyntaxNode):
    ...
    def __new__(cls, left_operator: SimpleMeksoOperatorSyntax, connective: StandardStatementConnectiveSyntax, tense_modal: TenseModalSyntax | None, bo: WithFreeModifiers[Token, FreeModifierSyntax], right_operator: InnerMeksoOperatorSyntax) -> BoundMeksoOperatorSyntax:
        return cls._from_fields((left_operator, connective, tense_modal, bo, right_operator))
    def __init__(self, left_operator: SimpleMeksoOperatorSyntax, connective: StandardStatementConnectiveSyntax, tense_modal: TenseModalSyntax | None, bo: WithFreeModifiers[Token, FreeModifierSyntax], right_operator: InnerMeksoOperatorSyntax) -> None:
        pass
    @property
    ...
    def right_operator(self) -> InnerMeksoOperatorSyntax:
        ...
        return cast(InnerMeksoOperatorSyntax, self._field(4))
    def __init_subclass__(cls) -> None:
...
class SimpleMeksoOperatorSyntaxAtomicMeksoOperator(_SyntaxNode):
    ...
    def __init__(self, atomic_mekso_operator: AtomicMeksoOperatorSyntax) -> None:
        pass
    @property
    def atomic_mekso_operator(self) -> AtomicMeksoOperatorSyntax:
        'Uses the nested atomic operator sum form.'
        return cast(AtomicMeksoOperatorSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SimpleMeksoOperatorSyntaxAtomicMeksoOperator is final')
...
class AtomicMeksoOperatorSyntaxConvertedMeksoOperator(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('AtomicMeksoOperatorSyntaxConvertedMeksoOperator is final')
...
class AtomicMeksoOperatorSyntaxScalarNegatedMeksoOperator(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('AtomicMeksoOperatorSyntaxScalarNegatedMeksoOperator is final')
...
class AtomicMeksoOperatorSyntaxSelbriMeksoOperator(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('AtomicMeksoOperatorSyntaxSelbriMeksoOperator is final')
...
class AtomicMeksoOperatorSyntaxOperandMeksoOperator(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('AtomicMeksoOperatorSyntaxOperandMeksoOperator is final')
...
class AtomicMeksoOperatorSyntaxExperimentalConnectiveMeksoOperator(_SyntaxNode):
    ...
    def __init__(self, experimental_connective_mekso_operator: ExperimentalConnectiveMeksoOperatorSyntax) -> None:
        pass
    @property
    def experimental_connective_mekso_operator(self) -> ExperimentalConnectiveMeksoOperatorSyntax:
        'Uses a camxes-exp connective as an atomic operator.'
        return cast(ExperimentalConnectiveMeksoOperatorSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('AtomicMeksoOperatorSyntaxExperimentalConnectiveMeksoOperator is final')
...
class AtomicMeksoOperatorSyntaxPrimitiveMeksoOperator(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('AtomicMeksoOperatorSyntaxPrimitiveMeksoOperator is final')
...
class ConvertedMeksoOperatorSyntax(_SyntaxNode):
    ...
    def __init__(self, se: WithFreeModifiers[Token, FreeModifierSyntax], inner_operator: AtomicMeksoOperatorSyntax) -> None:
        pass
    @property
    ...
    def inner_operator(self) -> AtomicMeksoOperatorSyntax:
        ...
        return cast(AtomicMeksoOperatorSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
...
class ScalarNegatedMeksoOperatorSyntax(_SyntaxNode):
    ...
    def __init__(self, nahe: WithFreeModifiers[Token, FreeModifierSyntax], inner_operator: AtomicMeksoOperatorSyntax) -> None:
        pass
    @property
...
class ForethoughtMeksoOperatorSyntax(_SyntaxNode):
    ...
    def __new__(cls, guhek: OperatorGuhekConnectiveSyntax, left_operator: InnerMeksoOperatorSyntax, gik: GikConnectiveSyntax, right_operator: SimpleMeksoOperatorSyntax) -> ForethoughtMeksoOperatorSyntax:
        return cls._from_fields((guhek, left_operator, gik, right_operator))
    def __init__(self, guhek: OperatorGuhekConnectiveSyntax, left_operator: InnerMeksoOperatorSyntax, gik: GikConnectiveSyntax, right_operator: SimpleMeksoOperatorSyntax) -> None:
        pass
    @property
    def guhek(self) -> OperatorGuhekConnectiveSyntax:
        'The operator-context forethought connective.'
        return cast(OperatorGuhekConnectiveSyntax, self._field(0))
    @property
    ...
    def right_operator(self) -> SimpleMeksoOperatorSyntax:
        ...
        return cast(SimpleMeksoOperatorSyntax, self._field(3))
    def __init_subclass__(cls) -> None:
...
class OperatorGuhekConnectiveSyntax(_SyntaxNode):
    ...
    def __new__(cls, se: Token | None, guha: WithFreeModifiers[Token, FreeModifierSyntax], nai: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> OperatorGuhekConnectiveSyntax:
        return cls._from_fields((se, guha, nai))
    def __init__(self, se: Token | None, guha: WithFreeModifiers[Token, FreeModifierSyntax], nai: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    ...
    def nai(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('OperatorGuhekConnectiveSyntax is final')
...
class ExperimentalConnectiveMeksoOperatorSyntaxStandardStatementConnective(_SyntaxNode):
    ...
    def standard_statement_connective(self) -> StandardStatementConnectiveSyntax:
        ...
        return cast(StandardStatementConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ExperimentalConnectiveMeksoOperatorSyntaxStandardStatementConnective is final')
...
class ExperimentalConnectiveMeksoOperatorSyntaxEkConnective(_SyntaxNode):
    ...
    def ek_connective(self) -> EkConnectiveSyntax:
        ...
        return cast(EkConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ExperimentalConnectiveMeksoOperatorSyntaxEkConnective is final')
...
class MeksoOperandSyntax(_SyntaxNode):
    ...
    def __init__(self, connected_expression: AfterthoughtMeksoOperandSyntax, grouped_continuation: GroupedMeksoOperandContinuationSyntax | None) -> None:
        pass
    @property
    ...
    def grouped_continuation(self) -> GroupedMeksoOperandContinuationSyntax | None:
        ...
        return cast(GroupedMeksoOperandContinuationSyntax | None, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('MeksoOperandSyntax is final')
...
class GroupedMeksoOperandContinuationSyntax(_SyntaxNode):
    ...
    def __new__(cls, operand_connective: OperandConnectiveSyntax, tense_modal: TenseModalSyntax | None, ke: WithFreeModifiers[Token, FreeModifierSyntax], inner_expression: MeksoOperandSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> GroupedMeksoOperandContinuationSyntax:
        return cls._from_fields((operand_connective, tense_modal, ke, inner_expression, kehe))
    def __init__(self, operand_connective: OperandConnectiveSyntax, tense_modal: TenseModalSyntax | None, ke: WithFreeModifiers[Token, FreeModifierSyntax], inner_expression: MeksoOperandSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    ...
    def kehe(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(4))
    def __init_subclass__(cls) -> None:
        raise TypeError('GroupedMeksoOperandContinuationSyntax is final')
...
class BoundMeksoOperandSyntax(_SyntaxNode):
    ...
    def __new__(cls, left_expression: SimpleMeksoOperandSyntax, operand_connective: OperandConnectiveSyntax, tense_modal: TenseModalSyntax | None, bo: WithFreeModifiers[Token, FreeModifierSyntax], right_expression: BoundOrSimpleMeksoOperandSyntax) -> BoundMeksoOperandSyntax:
        return cls._from_fields((left_expression, operand_connective, tense_modal, bo, right_expression))
    def __init__(self, left_expression: SimpleMeksoOperandSyntax, operand_connective: OperandConnectiveSyntax, tense_modal: TenseModalSyntax | None, bo: WithFreeModifiers[Token, FreeModifierSyntax], right_expression: BoundOrSimpleMeksoOperandSyntax) -> None:
        pass
    @property
    ...
    def right_expression(self) -> BoundOrSimpleMeksoOperandSyntax:
        ...
        return cast(BoundOrSimpleMeksoOperandSyntax, self._field(4))
    def __init_subclass__(cls) -> None:
...
class SimpleMeksoOperandSyntaxScalarNegatedMeksoOperand(_SyntaxNode):
    ...
    def __init__(self, scalar_negated_mekso_operand: ScalarNegatedMeksoOperandSyntax) -> None:
        pass
    @property
    def scalar_negated_mekso_operand(self) -> ScalarNegatedMeksoOperandSyntax:
        'Uses the `scalar_negated_mekso_operand` product form, whose payload preserves `nahe`, `inner_expression`, and `luhu`.'
        return cast(ScalarNegatedMeksoOperandSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SimpleMeksoOperandSyntaxScalarNegatedMeksoOperand is final')
...
class SimpleMeksoOperandSyntaxLaheQualifiedMeksoOperand(_SyntaxNode):
    ...
    def __init__(self, lahe_qualified_mekso_operand: LaheQualifiedMeksoOperandSyntax) -> None:
        pass
    @property
    def lahe_qualified_mekso_operand(self) -> LaheQualifiedMeksoOperandSyntax:
        'Uses the `lahe_qualified_mekso_operand` product form, whose payload preserves `lahe`, `inner_expression`, and `luhu`.'
        return cast(LaheQualifiedMeksoOperandSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SimpleMeksoOperandSyntaxLaheQualifiedMeksoOperand is final')
...
class ScalarNegatedMeksoOperandSyntax(_SyntaxNode):
    ...
    def __new__(cls, nahe: WithFreeModifiers[Token, FreeModifierSyntax], inner_expression: MeksoOperandSyntax, luhu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ScalarNegatedMeksoOperandSyntax:
        return cls._from_fields((nahe, inner_expression, luhu))
    def __init__(self, nahe: WithFreeModifiers[Token, FreeModifierSyntax], inner_expression: MeksoOperandSyntax, luhu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def nahe(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
    ...
    def luhu(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ScalarNegatedMeksoOperandSyntax is final')
...
class LaheQualifiedMeksoOperandSyntax(_SyntaxNode):
    ...
    def __new__(cls, lahe: WithFreeModifiers[Token, FreeModifierSyntax], inner_expression: MeksoOperandSyntax, luhu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> LaheQualifiedMeksoOperandSyntax:
        return cls._from_fields((lahe, inner_expression, luhu))
    def __init__(self, lahe: WithFreeModifiers[Token, FreeModifierSyntax], inner_expression: MeksoOperandSyntax, luhu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    ...
    def luhu(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('LaheQualifiedMeksoOperandSyntax is final')
...
class ForethoughtMeksoOperandSyntax(_SyntaxNode):
    ...
    def __new__(cls, gek: ModalForethoughtConnectiveSyntax, left_expression: MeksoOperandSyntax, gik: GikConnectiveSyntax, right_expression: SimpleMeksoOperandSyntax) -> ForethoughtMeksoOperandSyntax:
        return cls._from_fields((gek, left_expression, gik, right_expression))
    def __init__(self, gek: ModalForethoughtConnectiveSyntax, left_expression: MeksoOperandSyntax, gik: GikConnectiveSyntax, right_expression: SimpleMeksoOperandSyntax) -> None:
        pass
    @property
    def gek(self) -> ModalForethoughtConnectiveSyntax:
    ...
    def right_expression(self) -> SimpleMeksoOperandSyntax:
        ...
        return cast(SimpleMeksoOperandSyntax, self._field(3))
    def __init_subclass__(cls) -> None:
...
class ArrayMeksoOperandSyntax(_SyntaxNode):
    ...
    def __new__(cls, johi: WithFreeModifiers[Token, FreeModifierSyntax], expressions: Sequence[StandardMeksoArrayElementSyntax], tehu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ArrayMeksoOperandSyntax:
        return cls._from_fields((johi, expressions, tehu))
    def __init__(self, johi: WithFreeModifiers[Token, FreeModifierSyntax], expressions: Sequence[StandardMeksoArrayElementSyntax], tehu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    ...
    def expressions(self) -> tuple[StandardMeksoArrayElementSyntax, ...]:
        ...
        return cast(tuple[StandardMeksoArrayElementSyntax, ...], self._field(1))
    @property
    def tehu(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        'The optional `Tehu` cmavo marker.'
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(2))
...
class StandardMeksoArrayElementSyntaxMeksoOperand(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('StandardMeksoArrayElementSyntaxMeksoOperand is final')
...
class StandardMeksoArrayElementSyntaxForethoughtCallMekso(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('StandardMeksoArrayElementSyntaxForethoughtCallMekso is final')
...
class MeksoSyntaxReinterpretZantufaMex(_SyntaxNode):
    ...
    def __init__(self, reinterpret_zantufa_mex: ReinterpretZantufaMexSyntax) -> None:
        pass
    @property
    def reinterpret_zantufa_mex(self) -> ReinterpretZantufaMexSyntax:
        'Gives the faithful Zantufa projection priority only under the meaning-changing flag.'
        return cast(ReinterpretZantufaMexSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('MeksoSyntaxReinterpretZantufaMex is final')
...
class MeksoSyntaxZantufaPriorityMex(_SyntaxNode):
    ...
    def __init__(self, zantufa_priority_mex: ZantufaPriorityMexSyntax) -> None:
        pass
    @property
    def zantufa_priority_mex(self) -> ZantufaPriorityMexSyntax:
        'Gives Zantufa-only continuations priority while handing baseline surfaces back.'
        return cast(ZantufaPriorityMexSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('MeksoSyntaxZantufaPriorityMex is final')
...
class MeksoSyntaxZantufaMex(_SyntaxNode):
    ...
    def __init__(self, zantufa_mex: ZantufaMexSyntax) -> None:
        pass
    @property
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('MeksoSyntaxZantufaMex is final')
...
class ZantufaPriorityMexSyntax(_SyntaxNode):
    ...
    def __init__(self, mex: ZantufaMexSyntax) -> None:
        pass
    @property
    def mex(self) -> ZantufaMexSyntax:
        ...
        return cast(ZantufaMexSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaPriorityMexSyntax is final')
...
class ReinterpretZantufaMexSyntax(_SyntaxNode):
    ...
    def mex(self) -> ZantufaMexSyntax:
        ...
        return cast(ZantufaMexSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ReinterpretZantufaMexSyntax is final')
...
class ZantufaMexSyntax(_SyntaxNode):
    ...
    def __new__(cls, first_expression: ZantufaMex1Syntax, continuations: Sequence[ZantufaMexContinuationSyntax]) -> ZantufaMexSyntax:
        return cls._from_fields((first_expression, continuations))
    def __init__(self, first_expression: ZantufaMex1Syntax, continuations: Sequence[ZantufaMexContinuationSyntax]) -> None:
        pass
    @property
    def first_expression(self) -> ZantufaMex1Syntax:
        'The first mex_1 group.'
        return cast(ZantufaMex1Syntax, self._field(0))
    @property
    def continuations(self) -> tuple[ZantufaMexContinuationSyntax, ...]:
        'Source-ordered operator-led continuations.'
        return cast(tuple[ZantufaMexContinuationSyntax, ...], self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaMexSyntax is final')
...
class ZantufaMexContinuationSyntax(_SyntaxNode):
    ...
    def __init__(self, operators: Sequence[ZantufaOperatorSyntax], right_expression: ZantufaMex1Syntax | None) -> None:
        pass
    @property
    def operators(self) -> tuple[ZantufaOperatorSyntax, ...]:
        ...
        return cast(tuple[ZantufaOperatorSyntax, ...], self._field(0))
    @property
    def right_expression(self) -> ZantufaMex1Syntax | None:
        'The optional right mex_1 group.'
        return cast(ZantufaMex1Syntax | None, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaMexContinuationSyntax is final')
...
class ZantufaMex1Syntax(_SyntaxNode):
    ...
    def __init__(self, first_group: ZantufaMexGroupSyntax, tails: Sequence[ZantufaBiheMeksoTailSyntax]) -> None:
        pass
    @property
    def first_group(self) -> ZantufaMexGroupSyntax:
        'The leading mex_2 group.'
        return cast(ZantufaMexGroupSyntax, self._field(0))
    @property
    def tails(self) -> tuple[ZantufaBiheMeksoTailSyntax, ...]:
        'Repeated BIhE operator-sequence tails.'
        return cast(tuple[ZantufaBiheMeksoTailSyntax, ...], self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaMex1Syntax is final')
...
class ZantufaMexGroupSyntaxZantufaKeGroupedMekso(_SyntaxNode):
    ...
    def __init__(self, zantufa_ke_grouped_mekso: ZantufaKeGroupedMeksoSyntax) -> None:
        pass
    @property
    def zantufa_ke_grouped_mekso(self) -> ZantufaKeGroupedMeksoSyntax:
        'KE-grouped one-or-more mex_2 expressions.'
        return cast(ZantufaKeGroupedMeksoSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaMexGroupSyntaxZantufaKeGroupedMekso is final')
...
class ZantufaMexGroupSyntaxZantufaBoGroupedMekso(_SyntaxNode):
    ...
    def __init__(self, zantufa_bo_grouped_mekso: ZantufaBoGroupedMeksoSyntax) -> None:
        pass
    @property
    def zantufa_bo_grouped_mekso(self) -> ZantufaBoGroupedMeksoSyntax:
        'A mex_2 expression with zero or more BO-linked expressions.'
        return cast(ZantufaBoGroupedMeksoSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaMexGroupSyntaxZantufaBoGroupedMekso is final')
...
class ZantufaKeGroupedMeksoSyntax(_SyntaxNode):
    ...
    def __new__(cls, ke: WithFreeModifiers[Token, FreeModifierSyntax], expressions: Sequence[ZantufaMex2Syntax], kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ZantufaKeGroupedMeksoSyntax:
        return cls._from_fields((ke, expressions, kehe))
    def __init__(self, ke: WithFreeModifiers[Token, FreeModifierSyntax], expressions: Sequence[ZantufaMex2Syntax], kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def ke(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
    ...
    def expressions(self) -> tuple[ZantufaMex2Syntax, ...]:
        ...
        return cast(tuple[ZantufaMex2Syntax, ...], self._field(1))
    @property
    def kehe(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        'The optional KEhE terminator.'
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaKeGroupedMeksoSyntax is final')
...
class ZantufaBoGroupedMeksoSyntax(_SyntaxNode):
    ...
    def __new__(cls, first_expression: ZantufaMex2Syntax, continuations: Sequence[ZantufaBoGroupedMeksoContinuationSyntax]) -> ZantufaBoGroupedMeksoSyntax:
        return cls._from_fields((first_expression, continuations))
    def __init__(self, first_expression: ZantufaMex2Syntax, continuations: Sequence[ZantufaBoGroupedMeksoContinuationSyntax]) -> None:
        pass
    @property
    def first_expression(self) -> ZantufaMex2Syntax:
        'The first mex_2 expression.'
        return cast(ZantufaMex2Syntax, self._field(0))
    @property
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaBoGroupedMeksoSyntax is final')
...
class ZantufaBoGroupedMeksoContinuationSyntax(_SyntaxNode):
    ...
    def __init__(self, bo: WithFreeModifiers[Token, FreeModifierSyntax], expression: ZantufaMex2Syntax) -> None:
        pass
    @property
    def bo(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The BO marker.'
    ...
    def expression(self) -> ZantufaMex2Syntax:
        ...
        return cast(ZantufaMex2Syntax, self._field(1))
    def __init_subclass__(cls) -> None:
...
class ZantufaBiheMeksoTailSyntax(_SyntaxNode):
    ...
    def __new__(cls, bihe: WithFreeModifiers[Token, FreeModifierSyntax], operators: Sequence[ZantufaOperatorSyntax], right_group: ZantufaMexGroupSyntax | None) -> ZantufaBiheMeksoTailSyntax:
        return cls._from_fields((bihe, operators, right_group))
    def __init__(self, bihe: WithFreeModifiers[Token, FreeModifierSyntax], operators: Sequence[ZantufaOperatorSyntax], right_group: ZantufaMexGroupSyntax | None) -> None:
        pass
    @property
    def bihe(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The BIhE marker.'
    ...
    def operators(self) -> tuple[ZantufaOperatorSyntax, ...]:
        ...
        return cast(tuple[ZantufaOperatorSyntax, ...], self._field(1))
    @property
    def right_group(self) -> ZantufaMexGroupSyntax | None:
        'The optional following group.'
        return cast(ZantufaMexGroupSyntax | None, self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaBiheMeksoTailSyntax is final')
...
class ZantufaMex2SyntaxZantufaOperand(_SyntaxNode):
    ...
    def __init__(self, zantufa_operand: ZantufaOperandSyntax) -> None:
        pass
    @property
    def zantufa_operand(self) -> ZantufaOperandSyntax:
        'A Zantufa operand.'
        return cast(ZantufaOperandSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaMex2SyntaxZantufaOperand is final')
...
class ZantufaMex2SyntaxZantufaReversePolishMekso(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaMex2SyntaxZantufaReversePolishMekso is final')
...
class ZantufaMex2SyntaxZantufaForethoughtMekso(_SyntaxNode):
    ...
    def __init__(self, zantufa_forethought_mekso: ZantufaForethoughtMeksoSyntax) -> None:
        pass
    @property
    def zantufa_forethought_mekso(self) -> ZantufaForethoughtMeksoSyntax:
        'A Zantufa operator-first forethought expression.'
        return cast(ZantufaForethoughtMeksoSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaMex2SyntaxZantufaForethoughtMekso is final')
...
class ZantufaReversePolishMeksoSyntax(_SyntaxNode):
    ...
    def __new__(cls, fuha: WithFreeModifiers[Token, FreeModifierSyntax], operands: Sequence[ZantufaMex2Syntax], operator: ZantufaOperatorSyntax, tails: Sequence[ZantufaReversePolishTailSyntax], kuhe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ZantufaReversePolishMeksoSyntax:
        return cls._from_fields((fuha, operands, operator, tails, kuhe))
    def __init__(self, fuha: WithFreeModifiers[Token, FreeModifierSyntax], operands: Sequence[ZantufaMex2Syntax], operator: ZantufaOperatorSyntax, tails: Sequence[ZantufaReversePolishTailSyntax], kuhe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    ...
    def operator(self) -> ZantufaOperatorSyntax:
        ...
        return cast(ZantufaOperatorSyntax, self._field(2))
    @property
...
class ZantufaReversePolishTailSyntax(_SyntaxNode):
    ...
    def __init__(self, operands: Sequence[ZantufaMex2Syntax], operator: ZantufaOperatorSyntax) -> None:
        pass
    @property
    def operands(self) -> tuple[ZantufaMex2Syntax, ...]:
        'Ordered sequence of zero or more mex_2 expressions.'
        return cast(tuple[ZantufaMex2Syntax, ...], self._field(0))
    @property
    def operator(self) -> ZantufaOperatorSyntax:
        'The following Zantufa operator.'
        return cast(ZantufaOperatorSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
...
class ZantufaForethoughtMeksoSyntax(_SyntaxNode):
    ...
    def __new__(cls, peho: WithFreeModifiers[Token, FreeModifierSyntax] | None, operator: ZantufaOperatorSyntax, operands: Sequence[ZantufaMex2Syntax], continuation: ZantufaForethoughtMeksoSyntax | None, kuhe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ZantufaForethoughtMeksoSyntax:
        return cls._from_fields((peho, operator, operands, continuation, kuhe))
    def __init__(self, peho: WithFreeModifiers[Token, FreeModifierSyntax] | None, operator: ZantufaOperatorSyntax, operands: Sequence[ZantufaMex2Syntax], continuation: ZantufaForethoughtMeksoSyntax | None, kuhe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def peho(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
    ...
    def operands(self) -> tuple[ZantufaMex2Syntax, ...]:
        'Non-empty source-ordered mex_2 expressions.'
        return cast(tuple[ZantufaMex2Syntax, ...], self._field(2))
    @property
    def continuation(self) -> ZantufaForethoughtMeksoSyntax | None:
        'The optional recursively nested forethought tail.'
        return cast(ZantufaForethoughtMeksoSyntax | None, self._field(3))
    @property
    def kuhe(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        'The optional KUhE terminator.'
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(4))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaForethoughtMeksoSyntax is final')
...
class ZantufaOperandSyntaxNumberMekso(_SyntaxNode):
    ...
    def number_mekso(self) -> NumberMeksoSyntax:
        ...
        return cast(NumberMeksoSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperandSyntaxNumberMekso is final')
...
class ZantufaOperandSyntaxLerfuStringMekso(_SyntaxNode):
    ...
    def lerfu_string_mekso(self) -> LerfuStringMeksoSyntax:
        ...
        return cast(LerfuStringMeksoSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperandSyntaxLerfuStringMekso is final')
...
class ZantufaOperandSyntaxZantufaParenthesizedMeksoOperand(_SyntaxNode):
    ...
    def __init__(self, zantufa_parenthesized_mekso_operand: ZantufaParenthesizedMeksoOperandSyntax) -> None:
        pass
    @property
    def zantufa_parenthesized_mekso_operand(self) -> ZantufaParenthesizedMeksoOperandSyntax:
        'A VEI-grouped full Zantufa mex.'
        return cast(ZantufaParenthesizedMeksoOperandSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperandSyntaxZantufaParenthesizedMeksoOperand is final')
...
class ZantufaOperandSyntaxZantufaSelbriMoheMeksoOperand(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperandSyntaxZantufaSelbriMoheMeksoOperand is final')
...
class ZantufaOperandSyntaxZantufaSumtiMoheMeksoOperand(_SyntaxNode):
    ...
    def __init__(self, zantufa_sumti_mohe_mekso_operand: ZantufaSumtiMoheMeksoOperandSyntax) -> None:
        pass
    @property
    def zantufa_sumti_mohe_mekso_operand(self) -> ZantufaSumtiMoheMeksoOperandSyntax:
        'A MOhE sumti operand.'
        return cast(ZantufaSumtiMoheMeksoOperandSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperandSyntaxZantufaSumtiMoheMeksoOperand is final')
...
class ZantufaOperandSyntaxZantufaLaheQualifiedMeksoOperand(_SyntaxNode):
    ...
    def __init__(self, zantufa_lahe_qualified_mekso_operand: ZantufaLaheQualifiedMeksoOperandSyntax) -> None:
        pass
    @property
    def zantufa_lahe_qualified_mekso_operand(self) -> ZantufaLaheQualifiedMeksoOperandSyntax:
        'A LAhE-qualified full Zantufa mex.'
        return cast(ZantufaLaheQualifiedMeksoOperandSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperandSyntaxZantufaLaheQualifiedMeksoOperand is final')
...
class ZantufaOperandSyntaxZantufaNaheBoQualifiedMeksoOperand(_SyntaxNode):
    ...
    def __init__(self, zantufa_nahe_bo_qualified_mekso_operand: ZantufaNaheBoQualifiedMeksoOperandSyntax) -> None:
        pass
    @property
    def zantufa_nahe_bo_qualified_mekso_operand(self) -> ZantufaNaheBoQualifiedMeksoOperandSyntax:
        'A NAhE BO-qualified full Zantufa mex.'
        return cast(ZantufaNaheBoQualifiedMeksoOperandSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperandSyntaxZantufaNaheBoQualifiedMeksoOperand is final')
...
class ZantufaOperandSyntaxZantufaScalarNegatedMeksoOperand(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperandSyntaxZantufaScalarNegatedMeksoOperand is final')
...
class ZantufaParenthesizedMeksoOperandSyntax(_SyntaxNode):
    ...
    _schema_id = 386
    __match_args__ = ('vei', 'inner_expression', 'veho')
    def __new__(cls, vei: WithFreeModifiers[Token, FreeModifierSyntax], inner_expression: ZantufaMexSyntax, veho: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ZantufaParenthesizedMeksoOperandSyntax:
        return cls._from_fields((vei, inner_expression, veho))
    def __init__(self, vei: WithFreeModifiers[Token, FreeModifierSyntax], inner_expression: ZantufaMexSyntax, veho: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def vei(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The VEI marker.'
    ...
    def inner_expression(self) -> ZantufaMexSyntax:
        ...
        return cast(ZantufaMexSyntax, self._field(1))
    @property
    def veho(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        'The optional VEhO terminator.'
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaParenthesizedMeksoOperandSyntax is final')
...
class ZantufaSumtiMoheMeksoOperandSyntax(_SyntaxNode):
    ...
    _schema_id = 387
    __match_args__ = ('mohe', 'sumti', 'tehu')
    def __new__(cls, mohe: WithFreeModifiers[Token, FreeModifierSyntax], sumti: SumtiSyntax, tehu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ZantufaSumtiMoheMeksoOperandSyntax:
        return cls._from_fields((mohe, sumti, tehu))
    def __init__(self, mohe: WithFreeModifiers[Token, FreeModifierSyntax], sumti: SumtiSyntax, tehu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    ...
    def tehu(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaSumtiMoheMeksoOperandSyntax is final')
...
class ZantufaLaheQualifiedMeksoOperandSyntax(_SyntaxNode):
    ...
    _schema_id = 388
    __match_args__ = ('lahe', 'inner_expression', 'luhu')
    def __new__(cls, lahe: WithFreeModifiers[Token, FreeModifierSyntax], inner_expression: ZantufaMexSyntax, luhu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ZantufaLaheQualifiedMeksoOperandSyntax:
        return cls._from_fields((lahe, inner_expression, luhu))
    def __init__(self, lahe: WithFreeModifiers[Token, FreeModifierSyntax], inner_expression: ZantufaMexSyntax, luhu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def lahe(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The LAhE marker.'
    ...
    def luhu(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaLaheQualifiedMeksoOperandSyntax is final')
...
class ZantufaNaheBoQualifiedMeksoOperandSyntax(_SyntaxNode):
    ...
    _schema_id = 389
    __match_args__ = ('nahe', 'bo', 'inner_expression', 'luhu')
    def __new__(cls, nahe: WithFreeModifiers[Token, FreeModifierSyntax], bo: WithFreeModifiers[Token, FreeModifierSyntax], inner_expression: ZantufaMexSyntax, luhu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ZantufaNaheBoQualifiedMeksoOperandSyntax:
        return cls._from_fields((nahe, bo, inner_expression, luhu))
    def __init__(self, nahe: WithFreeModifiers[Token, FreeModifierSyntax], bo: WithFreeModifiers[Token, FreeModifierSyntax], inner_expression: ZantufaMexSyntax, luhu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def nahe(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The NAhE marker.'
    ...
    def inner_expression(self) -> ZantufaMexSyntax:
        'The full inner Zantufa mex.'
        return cast(ZantufaMexSyntax, self._field(2))
    @property
    def luhu(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        'The optional LUhU terminator.'
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(3))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaNaheBoQualifiedMeksoOperandSyntax is final')
...
class ZantufaScalarNegatedMeksoOperandSyntax(_SyntaxNode):
    ...
    def __init__(self, nahe: WithFreeModifiers[Token, FreeModifierSyntax], inner_expression: ZantufaOperandSyntax) -> None:
        pass
    @property
    def nahe(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The NAhE marker.'
    ...
    def inner_expression(self) -> ZantufaOperandSyntax:
        ...
        return cast(ZantufaOperandSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
...
class ZantufaOperatorSyntaxZantufaConvertedMeksoOperator(_SyntaxNode):
    ...
    def __init__(self, zantufa_converted_mekso_operator: ZantufaConvertedMeksoOperatorSyntax) -> None:
        pass
    @property
    def zantufa_converted_mekso_operator(self) -> ZantufaConvertedMeksoOperatorSyntax:
        'Recursive SE conversion.'
        return cast(ZantufaConvertedMeksoOperatorSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperatorSyntaxZantufaConvertedMeksoOperator is final')
...
class ZantufaOperatorSyntaxZantufaScalarNegatedMeksoOperator(_SyntaxNode):
    ...
    def __init__(self, zantufa_scalar_negated_mekso_operator: ZantufaScalarNegatedMeksoOperatorSyntax) -> None:
        pass
    @property
    def zantufa_scalar_negated_mekso_operator(self) -> ZantufaScalarNegatedMeksoOperatorSyntax:
        'Recursive NAhE scalar negation.'
        return cast(ZantufaScalarNegatedMeksoOperatorSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperatorSyntaxZantufaScalarNegatedMeksoOperator is final')
...
class ZantufaOperatorSyntaxZantufaMahoMeksoOperator(_SyntaxNode):
    ...
    def __init__(self, zantufa_maho_mekso_operator: ZantufaMahoMeksoOperatorSyntax) -> None:
        pass
    @property
    def zantufa_maho_mekso_operator(self) -> ZantufaMahoMeksoOperatorSyntax:
        'MAhO wrapping a full Zantufa mex.'
        return cast(ZantufaMahoMeksoOperatorSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperatorSyntaxZantufaMahoMeksoOperator is final')
...
class ZantufaOperatorSyntaxZantufaMahoSelbriMeksoOperator(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperatorSyntaxZantufaMahoSelbriMeksoOperator is final')
...
class ZantufaOperatorSyntaxZantufaMahoSumtiMeksoOperator(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperatorSyntaxZantufaMahoSumtiMeksoOperator is final')
...
class ZantufaOperatorSyntaxZantufaPrimitiveMeksoOperator(_SyntaxNode):
    ...
    def __init__(self, zantufa_primitive_mekso_operator: ZantufaPrimitiveMeksoOperatorSyntax) -> None:
        pass
    @property
    def zantufa_primitive_mekso_operator(self) -> ZantufaPrimitiveMeksoOperatorSyntax:
        'A primitive VUhU operator.'
        return cast(ZantufaPrimitiveMeksoOperatorSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperatorSyntaxZantufaPrimitiveMeksoOperator is final')
...
class ZantufaOperatorSyntaxZantufaConnectiveMeksoOperator(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaOperatorSyntaxZantufaConnectiveMeksoOperator is final')
...
class ZantufaConvertedMeksoOperatorSyntax(_SyntaxNode):
    ...
    def __new__(cls, se: WithFreeModifiers[Token, FreeModifierSyntax], inner_operator: ZantufaOperatorSyntax) -> ZantufaConvertedMeksoOperatorSyntax:
        return cls._from_fields((se, inner_operator))
    def __init__(self, se: WithFreeModifiers[Token, FreeModifierSyntax], inner_operator: ZantufaOperatorSyntax) -> None:
        pass
    @property
    def se(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The SE marker.'
    ...
    def inner_operator(self) -> ZantufaOperatorSyntax:
        ...
        return cast(ZantufaOperatorSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaConvertedMeksoOperatorSyntax is final')
...
class ZantufaScalarNegatedMeksoOperatorSyntax(_SyntaxNode):
    ...
    def __new__(cls, nahe: WithFreeModifiers[Token, FreeModifierSyntax], inner_operator: ZantufaOperatorSyntax) -> ZantufaScalarNegatedMeksoOperatorSyntax:
        return cls._from_fields((nahe, inner_operator))
    def __init__(self, nahe: WithFreeModifiers[Token, FreeModifierSyntax], inner_operator: ZantufaOperatorSyntax) -> None:
        pass
    @property
    def nahe(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The NAhE marker.'
    ...
    def inner_operator(self) -> ZantufaOperatorSyntax:
        ...
        return cast(ZantufaOperatorSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaScalarNegatedMeksoOperatorSyntax is final')
...
class ZantufaMahoMeksoOperatorSyntax(_SyntaxNode):
    ...
    _schema_id = 400
    __match_args__ = ('maho', 'mekso', 'tehu')
    def __new__(cls, maho: WithFreeModifiers[Token, FreeModifierSyntax], mekso: ZantufaMexSyntax, tehu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ZantufaMahoMeksoOperatorSyntax:
        return cls._from_fields((maho, mekso, tehu))
    def __init__(self, maho: WithFreeModifiers[Token, FreeModifierSyntax], mekso: ZantufaMexSyntax, tehu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def maho(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The MAhO marker.'
    ...
    def tehu(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaMahoMeksoOperatorSyntax is final')
...
class ZantufaPrimitiveMeksoOperatorSyntax(_SyntaxNode):
    ...
    def vuhu(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaPrimitiveMeksoOperatorSyntax is final')
...
class ScalarNegatedSumtiWithBoSyntax(_SyntaxNode):
    ...
    def __new__(cls, nahe: Token, bo: WithFreeModifiers[Token, FreeModifierSyntax], relative_clauses: RelativeClauseListSyntax | None, inner_sumti: SumtiSyntax, luhu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ScalarNegatedSumtiWithBoSyntax:
        return cls._from_fields((nahe, bo, relative_clauses, inner_sumti, luhu))
    def __init__(self, nahe: Token, bo: WithFreeModifiers[Token, FreeModifierSyntax], relative_clauses: RelativeClauseListSyntax | None, inner_sumti: SumtiSyntax, luhu: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def nahe(self) -> Token:
        'A word from selmaho `Nahe`.'
...
class NameSumtiSyntax(_SyntaxNode):
    ...
    def __new__(cls, la: WithFreeModifiers[Token, FreeModifierSyntax], relative_clauses: RelativeClauseListSyntax | None, names: WithFreeModifiers[Sequence[Token], FreeModifierSyntax]) -> NameSumtiSyntax:
        return cls._from_fields((la, relative_clauses, names))
    def __init__(self, la: WithFreeModifiers[Token, FreeModifierSyntax], relative_clauses: RelativeClauseListSyntax | None, names: WithFreeModifiers[Sequence[Token], FreeModifierSyntax]) -> None:
        pass
    @property
    ...
    def names(self) -> WithFreeModifiers[tuple[Token, ...], FreeModifierSyntax]:
        ...
        return cast(WithFreeModifiers[tuple[Token, ...], FreeModifierSyntax], self._field(2))
    def __init_subclass__(cls) -> None:
...
class XiFreeModifierSyntaxZantufaMex2XiFreeModifier(_SyntaxNode):
    ...
    def __init__(self, zantufa_mex_2_xi_free_modifier: ZantufaMex2XiFreeModifierSyntax) -> None:
        pass
    @property
    def zantufa_mex_2_xi_free_modifier(self) -> ZantufaMex2XiFreeModifierSyntax:
        'Uses an exact Zantufa mex_2 subscript only after all standard routes fail.'
        return cast(ZantufaMex2XiFreeModifierSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('XiFreeModifierSyntaxZantufaMex2XiFreeModifier is final')
...
class ZantufaMex2XiFreeModifierSyntax(_SyntaxNode):
    ...
    def __new__(cls, xi: WithFreeModifiers[Token, FreeModifierSyntax], expression: ZantufaMex2Syntax) -> ZantufaMex2XiFreeModifierSyntax:
        return cls._from_fields((xi, expression))
    def __init__(self, xi: WithFreeModifiers[Token, FreeModifierSyntax], expression: ZantufaMex2Syntax) -> None:
        pass
    @property
    def xi(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'A word from selmaho `Xi`.'
    ...
    def expression(self) -> ZantufaMex2Syntax:
        ...
        return cast(ZantufaMex2Syntax, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaMex2XiFreeModifierSyntax is final')
...
class ZantufaMeksoMaiFreeModifierSyntax(_SyntaxNode):
    ...
    def __init__(self, expression: ZantufaMex2Syntax, mai: WithFreeModifiers[Token, FreeModifierSyntax]) -> None:
        pass
    @property
    def expression(self) -> ZantufaMex2Syntax:
...
class RelativeClauseTailSyntaxRelativeClauseExpContinuation(_SyntaxNode):
    ...
    def __init__(self, relative_clause_exp_continuation: RelativeClauseExpContinuationSyntax) -> None:
        pass
    @property
    def relative_clause_exp_continuation(self) -> RelativeClauseExpContinuationSyntax:
        'Uses the ownership-filtered camxes-exp continuation route.'
        return cast(RelativeClauseExpContinuationSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('RelativeClauseTailSyntaxRelativeClauseExpContinuation is final')
...
class RelativeClauseTailSyntaxZantufaBareRelativeClauseTail(_SyntaxNode):
    ...
    def __init__(self, zantufa_bare_relative_clause_tail: ZantufaBareRelativeClauseTailSyntax) -> None:
        pass
    @property
    def zantufa_bare_relative_clause_tail(self) -> ZantufaBareRelativeClauseTailSyntax:
        'Uses a warning-gated bare adjacent relative clause.'
        return cast(ZantufaBareRelativeClauseTailSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('RelativeClauseTailSyntaxZantufaBareRelativeClauseTail is final')
...
class ZantufaBareRelativeClauseTailSyntax(_SyntaxNode):
    ...
    def __init__(self, inner: RelativeClauseAtomSyntax) -> None:
        pass
    @property
    def inner(self) -> RelativeClauseAtomSyntax:
        ...
        return cast(RelativeClauseAtomSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaBareRelativeClauseTailSyntax is final')
...
class RelativeClauseExpContinuationSyntax(_SyntaxNode):
    ...
    def __init__(self, continuation: ExpRelativeContinuationSyntax) -> None:
        pass
    @property
    def continuation(self) -> ExpRelativeContinuationSyntax:
        ...
        return cast(ExpRelativeContinuationSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('RelativeClauseExpContinuationSyntax is final')
...
class ExpRelativeContinuationSyntax(_SyntaxNode):
    ...
    def __init__(self, connective: ExpRelativeClauseConnectiveSyntax, inner: RelativeClauseAtomSyntax) -> None:
        pass
    @property
    def connective(self) -> ExpRelativeClauseConnectiveSyntax:
        'The camxes-exp connective joining the adjacent relative clauses.'
        return cast(ExpRelativeClauseConnectiveSyntax, self._field(0))
    @property
    def inner(self) -> RelativeClauseAtomSyntax:
        'The shared inner child syntax node.'
        return cast(RelativeClauseAtomSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ExpRelativeContinuationSyntax is final')
...
class ExpRelativeClauseConnectiveSyntax(_SyntaxNode):
    ...
    def __new__(cls, na: Token | None, se: Token | None, head: WithFreeModifiers[Token, FreeModifierSyntax], nai: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ExpRelativeClauseConnectiveSyntax:
        return cls._from_fields((na, se, head, nai))
    def __init__(self, na: Token | None, se: Token | None, head: WithFreeModifiers[Token, FreeModifierSyntax], nai: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    ...
    def nai(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(3))
    def __init_subclass__(cls) -> None:
        raise TypeError('ExpRelativeClauseConnectiveSyntax is final')
...
class JoikConnectiveSyntaxZantufaGahoJoikConnective(_SyntaxNode):
    ...
    def __init__(self, zantufa_gaho_joik_connective: ZantufaGahoJoikConnectiveSyntax) -> None:
        pass
    @property
    def zantufa_gaho_joik_connective(self) -> ZantufaGahoJoikConnectiveSyntax:
        'Zantufa JOIK beginning with GAhO; paired GAhO+BIhI was already claimed above.'
        return cast(ZantufaGahoJoikConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('JoikConnectiveSyntaxZantufaGahoJoikConnective is final')
...
class JoikConnectiveSyntaxZantufaRightGahoJoikConnective(_SyntaxNode):
    ...
    def __init__(self, zantufa_right_gaho_joik_connective: ZantufaRightGahoJoikConnectiveSyntax) -> None:
        pass
    @property
    def zantufa_right_gaho_joik_connective(self) -> ZantufaRightGahoJoikConnectiveSyntax:
        'Zantufa JOIK whose required right GAhO must be consumed before a simple arm can commit.'
        return cast(ZantufaRightGahoJoikConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('JoikConnectiveSyntaxZantufaRightGahoJoikConnective is final')
...
class JoikConnectiveSyntaxZantufaNaJoikConnective(_SyntaxNode):
    ...
    def __init__(self, zantufa_na_joik_connective: ZantufaNaJoikConnectiveSyntax) -> None:
        pass
    @property
    def zantufa_na_joik_connective(self) -> ZantufaNaJoikConnectiveSyntax:
        'Zantufa JOIK beginning with explicit NA.'
        return cast(ZantufaNaJoikConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('JoikConnectiveSyntaxZantufaNaJoikConnective is final')
...
class ZantufaGahoJoikConnectiveSyntax(_SyntaxNode):
    ...
    def __new__(cls, left_gaho: WithFreeModifiers[Token, FreeModifierSyntax], na: WithFreeModifiers[Token, FreeModifierSyntax] | None, se: WithFreeModifiers[Token, FreeModifierSyntax] | None, joiz: WithFreeModifiers[Token, FreeModifierSyntax], right_gaho: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ZantufaGahoJoikConnectiveSyntax:
        return cls._from_fields((left_gaho, na, se, joiz, right_gaho))
    def __init__(self, left_gaho: WithFreeModifiers[Token, FreeModifierSyntax], na: WithFreeModifiers[Token, FreeModifierSyntax] | None, se: WithFreeModifiers[Token, FreeModifierSyntax] | None, joiz: WithFreeModifiers[Token, FreeModifierSyntax], right_gaho: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    ...
    def right_gaho(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(4))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaGahoJoikConnectiveSyntax is final')
...
class ZantufaNaJoikConnectiveSyntax(_SyntaxNode):
    ...
    def __new__(cls, na: WithFreeModifiers[Token, FreeModifierSyntax], se: WithFreeModifiers[Token, FreeModifierSyntax] | None, joiz: WithFreeModifiers[Token, FreeModifierSyntax], right_gaho: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ZantufaNaJoikConnectiveSyntax:
        return cls._from_fields((na, se, joiz, right_gaho))
    def __init__(self, na: WithFreeModifiers[Token, FreeModifierSyntax], se: WithFreeModifiers[Token, FreeModifierSyntax] | None, joiz: WithFreeModifiers[Token, FreeModifierSyntax], right_gaho: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def na(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
    ...
    def right_gaho(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(3))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaNaJoikConnectiveSyntax is final')
...
class ZantufaRightGahoJoikConnectiveSyntax(_SyntaxNode):
    ...
    def __new__(cls, se: WithFreeModifiers[Token, FreeModifierSyntax] | None, joiz: WithFreeModifiers[Token, FreeModifierSyntax], right_gaho: WithFreeModifiers[Token, FreeModifierSyntax]) -> ZantufaRightGahoJoikConnectiveSyntax:
        return cls._from_fields((se, joiz, right_gaho))
    def __init__(self, se: WithFreeModifiers[Token, FreeModifierSyntax] | None, joiz: WithFreeModifiers[Token, FreeModifierSyntax], right_gaho: WithFreeModifiers[Token, FreeModifierSyntax]) -> None:
        pass
    @property
    def se(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        'Optional member reversal.'
    ...
    def right_gaho(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax], self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaRightGahoJoikConnectiveSyntax is final')
...
class SumtiConnectiveSyntaxJoikConnective(_SyntaxNode):
    ...
    def joik_connective(self) -> JoikConnectiveSyntax:
        ...
        return cast(JoikConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SumtiConnectiveSyntaxJoikConnective is final')
...
class SumtiConnectiveSyntaxEkConnective(_SyntaxNode):
    ...
    def ek_connective(self) -> EkConnectiveSyntax:
        ...
        return cast(EkConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SumtiConnectiveSyntaxEkConnective is final')
...
class SumtiConnectiveSyntaxJehiConnective(_SyntaxNode):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('SumtiConnectiveSyntaxJehiConnective is final')
...
class SumtiConnectiveSyntaxExperimentalVuhuSumtiConnective(_SyntaxNode):
    ...
    def __init__(self, experimental_vuhu_sumti_connective: ExperimentalVuhuSumtiConnectiveSyntax) -> None:
        pass
    @property
    def experimental_vuhu_sumti_connective(self) -> ExperimentalVuhuSumtiConnectiveSyntax:
        'Uses the warning-gated `experimental_vuhu_sumti_connective` product form, whose payload preserves `vuhu`.'
        return cast(ExperimentalVuhuSumtiConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SumtiConnectiveSyntaxExperimentalVuhuSumtiConnective is final')
...
class ExperimentalVuhuSumtiConnectiveSyntax(_SyntaxNode):
    ...
    def vuhu(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ExperimentalVuhuSumtiConnectiveSyntax is final')
...
class SelbriAfterthoughtConnectiveSyntaxJoikConnective(_SyntaxNode):
    ...
    def joik_connective(self) -> JoikConnectiveSyntax:
        ...
        return cast(JoikConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SelbriAfterthoughtConnectiveSyntaxJoikConnective is final')
...
class SelbriAfterthoughtConnectiveSyntaxJekConnective(_SyntaxNode):
    ...
    def jek_connective(self) -> JekConnectiveSyntax:
        ...
        return cast(JekConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SelbriAfterthoughtConnectiveSyntaxJekConnective is final')
...
class ParagraphStandardStatementConnectiveSyntaxParagraphZantufaGahoJoikConnective(_SyntaxNode):
    ...
    def __init__(self, paragraph_zantufa_gaho_joik_connective: ParagraphZantufaGahoJoikConnectiveSyntax) -> None:
        pass
    @property
    def paragraph_zantufa_gaho_joik_connective(self) -> ParagraphZantufaGahoJoikConnectiveSyntax:
        'Zantufa paragraph JOIK beginning with GAhO.'
        return cast(ParagraphZantufaGahoJoikConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ParagraphStandardStatementConnectiveSyntaxParagraphZantufaGahoJoikConnective is final')
...
class ParagraphStandardStatementConnectiveSyntaxParagraphZantufaRightGahoJoikConnective(_SyntaxNode):
    ...
    def __init__(self, paragraph_zantufa_right_gaho_joik_connective: ParagraphZantufaRightGahoJoikConnectiveSyntax) -> None:
        pass
    @property
    def paragraph_zantufa_right_gaho_joik_connective(self) -> ParagraphZantufaRightGahoJoikConnectiveSyntax:
        'Zantufa paragraph JOIK whose required right GAhO precedes simple ownership.'
        return cast(ParagraphZantufaRightGahoJoikConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ParagraphStandardStatementConnectiveSyntaxParagraphZantufaRightGahoJoikConnective is final')
...
class ParagraphStandardStatementConnectiveSyntaxParagraphZantufaNaJoikConnective(_SyntaxNode):
    ...
    def __init__(self, paragraph_zantufa_na_joik_connective: ParagraphZantufaNaJoikConnectiveSyntax) -> None:
        pass
    @property
    def paragraph_zantufa_na_joik_connective(self) -> ParagraphZantufaNaJoikConnectiveSyntax:
        'Zantufa paragraph JOIK beginning with explicit NA.'
        return cast(ParagraphZantufaNaJoikConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ParagraphStandardStatementConnectiveSyntaxParagraphZantufaNaJoikConnective is final')
...
class ParagraphZantufaGahoJoikConnectiveSyntax(_SyntaxNode):
    ...
    _schema_id = 560
    __match_args__ = ('left_gaho', 'na', 'se', 'joiz', 'right_gaho')
    def __new__(cls, left_gaho: Token, na: Token | None, se: Token | None, joiz: Token, right_gaho: Token | None) -> ParagraphZantufaGahoJoikConnectiveSyntax:
        return cls._from_fields((left_gaho, na, se, joiz, right_gaho))
    def __init__(self, left_gaho: Token, na: Token | None, se: Token | None, joiz: Token, right_gaho: Token | None) -> None:
        pass
    @property
    ...
    def joiz(self) -> Token:
        ...
        return cast(Token, self._field(3))
    @property
    def right_gaho(self) -> Token | None:
        'Optional independent right endpoint marker.'
        return cast(Token | None, self._field(4))
    def __init_subclass__(cls) -> None:
        raise TypeError('ParagraphZantufaGahoJoikConnectiveSyntax is final')
...
class ParagraphZantufaNaJoikConnectiveSyntax(_SyntaxNode):
    ...
    _schema_id = 561
    __match_args__ = ('na', 'se', 'joiz', 'right_gaho')
    def __new__(cls, na: Token, se: Token | None, joiz: Token, right_gaho: Token | None) -> ParagraphZantufaNaJoikConnectiveSyntax:
        return cls._from_fields((na, se, joiz, right_gaho))
    def __init__(self, na: Token, se: Token | None, joiz: Token, right_gaho: Token | None) -> None:
        pass
    @property
    def na(self) -> Token:
    ...
    def right_gaho(self) -> Token | None:
        ...
        return cast(Token | None, self._field(3))
    def __init_subclass__(cls) -> None:
        raise TypeError('ParagraphZantufaNaJoikConnectiveSyntax is final')
...
class ParagraphZantufaRightGahoJoikConnectiveSyntax(_SyntaxNode):
    ...
    _schema_id = 562
    __match_args__ = ('se', 'joiz', 'right_gaho')
    def __new__(cls, se: Token | None, joiz: Token, right_gaho: Token) -> ParagraphZantufaRightGahoJoikConnectiveSyntax:
        return cls._from_fields((se, joiz, right_gaho))
    def __init__(self, se: Token | None, joiz: Token, right_gaho: Token) -> None:
        pass
    @property
    def se(self) -> Token | None:
        'Optional member reversal.'
    ...
    def right_gaho(self) -> Token:
        ...
        return cast(Token, self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ParagraphZantufaRightGahoJoikConnectiveSyntax is final')
...
class GuhekConnectiveSyntax(_SyntaxNode):
    ...
    _schema_id = 571
    __match_args__ = ('se', 'guha', 'nai')
    def __new__(cls, se: Token | None, guha: WithFreeModifiers[Token, FreeModifierSyntax], nai: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> GuhekConnectiveSyntax:
        return cls._from_fields((se, guha, nai))
    def __init__(self, se: Token | None, guha: WithFreeModifiers[Token, FreeModifierSyntax], nai: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
...
class ModalForethoughtConnectiveSyntaxZantufaGaBoForethoughtConnective(_SyntaxNode):
    ...
    def __init__(self, zantufa_ga_bo_forethought_connective: ZantufaGaBoForethoughtConnectiveSyntax) -> None:
        pass
    @property
    def zantufa_ga_bo_forethought_connective(self) -> ZantufaGaBoForethoughtConnectiveSyntax:
        'Zantufa GA form with required BO and no structural NAI.'
        return cast(ZantufaGaBoForethoughtConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ModalForethoughtConnectiveSyntaxZantufaGaBoForethoughtConnective is final')
...
class ModalForethoughtConnectiveSyntaxZantufaModalGiBoForethoughtConnective(_SyntaxNode):
    ...
    def __init__(self, zantufa_modal_gi_bo_forethought_connective: ZantufaModalGiBoForethoughtConnectiveSyntax) -> None:
        pass
    @property
    def zantufa_modal_gi_bo_forethought_connective(self) -> ZantufaModalGiBoForethoughtConnectiveSyntax:
        'Zantufa tag-GI form with required BO and no structural NAI.'
        return cast(ZantufaModalGiBoForethoughtConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ModalForethoughtConnectiveSyntaxZantufaModalGiBoForethoughtConnective is final')
...
class ModalForethoughtConnectiveSyntaxZantufaInitialGiTagForethoughtConnective(_SyntaxNode):
    ...
    def __init__(self, zantufa_initial_gi_tag_forethought_connective: ZantufaInitialGiTagForethoughtConnectiveSyntax) -> None:
        pass
    @property
    def zantufa_initial_gi_tag_forethought_connective(self) -> ZantufaInitialGiTagForethoughtConnectiveSyntax:
        'Zantufa GI-first opening whose tail is a whole rolling-Zantufa tag.'
        return cast(ZantufaInitialGiTagForethoughtConnectiveSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ModalForethoughtConnectiveSyntaxZantufaInitialGiTagForethoughtConnective is final')
...
class ZantufaGaBoForethoughtConnectiveSyntax(_SyntaxNode):
    ...
    def __new__(cls, se: Token | None, ga: WithFreeModifiers[Token, FreeModifierSyntax], bo: WithFreeModifiers[Token, FreeModifierSyntax]) -> ZantufaGaBoForethoughtConnectiveSyntax:
        return cls._from_fields((se, ga, bo))
    def __init__(self, se: Token | None, ga: WithFreeModifiers[Token, FreeModifierSyntax], bo: WithFreeModifiers[Token, FreeModifierSyntax]) -> None:
        pass
    @property
    def se(self) -> Token | None:
        'Optional member reversal.'
    ...
    def bo(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax], self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaGaBoForethoughtConnectiveSyntax is final')
...
class ZantufaInitialGiTagForethoughtConnectiveSyntax(_SyntaxNode):
    ...
    def __new__(cls, gi: WithFreeModifiers[Token, FreeModifierSyntax], tag: ZantufaTagSyntax, bo: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ZantufaInitialGiTagForethoughtConnectiveSyntax:
        return cls._from_fields((gi, tag, bo))
    def __init__(self, gi: WithFreeModifiers[Token, FreeModifierSyntax], tag: ZantufaTagSyntax, bo: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def gi(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
    ...
    def tag(self) -> ZantufaTagSyntax:
        ...
        return cast(ZantufaTagSyntax, self._field(1))
    @property
    def bo(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        'Optional BO suffix immediately after the connective cluster.'
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaInitialGiTagForethoughtConnectiveSyntax is final')
...
class ZantufaModalGiBoForethoughtConnectiveSyntax(_SyntaxNode):
    ...
    def __new__(cls, tense_modal: TenseModalSyntax, gi: WithFreeModifiers[Token, FreeModifierSyntax], bo: WithFreeModifiers[Token, FreeModifierSyntax]) -> ZantufaModalGiBoForethoughtConnectiveSyntax:
        return cls._from_fields((tense_modal, gi, bo))
    def __init__(self, tense_modal: TenseModalSyntax, gi: WithFreeModifiers[Token, FreeModifierSyntax], bo: WithFreeModifiers[Token, FreeModifierSyntax]) -> None:
        pass
    @property
    def tense_modal(self) -> TenseModalSyntax:
        'Tag preceding GI.'
    ...
    def bo(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax], self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaModalGiBoForethoughtConnectiveSyntax is final')
...
class ModalGiForethoughtConnectiveSyntax(_SyntaxNode):
    ...
    def __new__(cls, tense_modal: TenseModalSyntax, gi: WithFreeModifiers[Token, FreeModifierSyntax], nai: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ModalGiForethoughtConnectiveSyntax:
        return cls._from_fields((tense_modal, gi, nai))
    def __init__(self, tense_modal: TenseModalSyntax, gi: WithFreeModifiers[Token, FreeModifierSyntax], nai: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def tense_modal(self) -> TenseModalSyntax:
        'The shared tense modal child syntax node.'
...
class NumberedIntervalPropertyTenseSyntax(_SyntaxNode):
    ...
    def __init__(self, number: WithFreeModifiers[NumberWordsSyntax, FreeModifierSyntax], roi: WithFreeModifiers[Token, FreeModifierSyntax], nai: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
...
class SelbriSyntaxReinterpretZantufaAssignedSelbri(_SyntaxNode):
    ...
    def __init__(self, reinterpret_zantufa_assigned_selbri: ReinterpretZantufaAssignedSelbriSyntax) -> None:
        pass
    @property
    def reinterpret_zantufa_assigned_selbri(self) -> ReinterpretZantufaAssignedSelbriSyntax:
        'Faithful full-selbri CEI ownership selected by the meaning-changing flag.'
        return cast(ReinterpretZantufaAssignedSelbriSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SelbriSyntaxReinterpretZantufaAssignedSelbri is final')
...
class SelbriSyntaxZantufaRelativeSelbri(_SyntaxNode):
    ...
    def __init__(self, zantufa_relative_selbri: ZantufaRelativeSelbriSyntax) -> None:
        pass
    @property
    def zantufa_relative_selbri(self) -> ZantufaRelativeSelbriSyntax:
        'Rolling-Zantufa selbri-level relative attachment.'
        return cast(ZantufaRelativeSelbriSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
...
class SelbriSyntaxZantufaPriorityAssignedSelbri(_SyntaxNode):
    ...
    def __init__(self, zantufa_priority_assigned_selbri: ZantufaPriorityAssignedSelbriSyntax) -> None:
        pass
    @property
    def zantufa_priority_assigned_selbri(self) -> ZantufaPriorityAssignedSelbriSyntax:
        'A Zantufa CEI chain whose assignments take full selbri operands.'
        return cast(ZantufaPriorityAssignedSelbriSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SelbriSyntaxZantufaPriorityAssignedSelbri is final')
...
class ReinterpretZantufaAssignedSelbriSyntax(_SyntaxNode):
    ...
    def __new__(cls, selbri: ZantufaAssignedSelbriSyntax) -> ReinterpretZantufaAssignedSelbriSyntax:
        return cls._from_fields((selbri,))
    def __init__(self, selbri: ZantufaAssignedSelbriSyntax) -> None:
        pass
    @property
    def selbri(self) -> ZantufaAssignedSelbriSyntax:
        'The faithful rolling-Zantufa assignment candidate.'
        return cast(ZantufaAssignedSelbriSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ReinterpretZantufaAssignedSelbriSyntax is final')
...
class ZantufaRelativeSelbriSyntax(_SyntaxNode):
    ...
    def __new__(cls, leading_selbri: CoSelbriSyntax, relative_clauses: RelativeClauseListSyntax, assignments: Sequence[ZantufaSelbriAssignmentSyntax]) -> ZantufaRelativeSelbriSyntax:
        return cls._from_fields((leading_selbri, relative_clauses, assignments))
    def __init__(self, leading_selbri: CoSelbriSyntax, relative_clauses: RelativeClauseListSyntax, assignments: Sequence[ZantufaSelbriAssignmentSyntax]) -> None:
        pass
    @property
    ...
    def assignments(self) -> tuple[ZantufaSelbriAssignmentSyntax, ...]:
        ...
        return cast(tuple[ZantufaSelbriAssignmentSyntax, ...], self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaRelativeSelbriSyntax is final')
...
class ZantufaPriorityAssignedSelbriSyntax(_SyntaxNode):
    ...
    def selbri(self) -> ZantufaAssignedSelbriSyntax:
        ...
        return cast(ZantufaAssignedSelbriSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaPriorityAssignedSelbriSyntax is final')
...
class ZantufaAssignedSelbriSyntax(_SyntaxNode):
    ...
    def __init__(self, leading_selbri: CoSelbriSyntax, assignments: Sequence[ZantufaSelbriAssignmentSyntax]) -> None:
        pass
    @property
    def leading_selbri(self) -> CoSelbriSyntax:
    ...
    def assignments(self) -> tuple[ZantufaSelbriAssignmentSyntax, ...]:
        ...
        return cast(tuple[ZantufaSelbriAssignmentSyntax, ...], self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaAssignedSelbriSyntax is final')
...
class ZantufaAssignedSelbriWithoutTerminalRelativeSyntax(_SyntaxNode):
    ...
    def __new__(cls, leading_selbri: CoSelbriSyntax, preceding_assignments: Sequence[ZantufaSelbriAssignmentSyntax], final_assignment: ZantufaSelbriAssignmentWithoutTerminalRelativeSyntax) -> ZantufaAssignedSelbriWithoutTerminalRelativeSyntax:
        return cls._from_fields((leading_selbri, preceding_assignments, final_assignment))
    def __init__(self, leading_selbri: CoSelbriSyntax, preceding_assignments: Sequence[ZantufaSelbriAssignmentSyntax], final_assignment: ZantufaSelbriAssignmentWithoutTerminalRelativeSyntax) -> None:
        pass
    @property
    def leading_selbri(self) -> CoSelbriSyntax:
        'The level-2 selbri to which the assignments apply.'
    ...
    def final_assignment(self) -> ZantufaSelbriAssignmentWithoutTerminalRelativeSyntax:
        ...
        return cast(ZantufaSelbriAssignmentWithoutTerminalRelativeSyntax, self._field(2))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaAssignedSelbriWithoutTerminalRelativeSyntax is final')
...
class SelbriWithoutTerminalRelativeSyntaxZantufaPriorityAssignedSelbriWithoutTerminalRelative(_SyntaxNode):
    ...
    def __init__(self, zantufa_priority_assigned_selbri_without_terminal_relative: ZantufaPriorityAssignedSelbriWithoutTerminalRelativeSyntax) -> None:
        pass
    @property
    def zantufa_priority_assigned_selbri_without_terminal_relative(self) -> ZantufaPriorityAssignedSelbriWithoutTerminalRelativeSyntax:
        'A filtered full-selbri CEI chain whose final operand stays restricted.'
        return cast(ZantufaPriorityAssignedSelbriWithoutTerminalRelativeSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SelbriWithoutTerminalRelativeSyntaxZantufaPriorityAssignedSelbriWithoutTerminalRelative is final')
...
class SelbriWithoutTerminalRelativeSyntaxTaggedSelbriWithoutTerminalRelative(_SyntaxNode):
    ...
    def __init__(self, tagged_selbri_without_terminal_relative: TaggedSelbriWithoutTerminalRelativeSyntax) -> None:
        pass
    @property
    def tagged_selbri_without_terminal_relative(self) -> TaggedSelbriWithoutTerminalRelativeSyntax:
        'A tagged selbri whose recursive right edge stays restricted.'
        return cast(TaggedSelbriWithoutTerminalRelativeSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SelbriWithoutTerminalRelativeSyntaxTaggedSelbriWithoutTerminalRelative is final')
...
class SelbriWithoutTerminalRelativeSyntaxUntaggedSelbriWithoutTerminalRelative(_SyntaxNode):
    ...
    def __init__(self, untagged_selbri_without_terminal_relative: UntaggedSelbriWithoutTerminalRelativeSyntax) -> None:
        pass
    @property
    def untagged_selbri_without_terminal_relative(self) -> UntaggedSelbriWithoutTerminalRelativeSyntax:
        'An untagged selbri whose NA right edge stays restricted.'
        return cast(UntaggedSelbriWithoutTerminalRelativeSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('SelbriWithoutTerminalRelativeSyntaxUntaggedSelbriWithoutTerminalRelative is final')
...
class ZantufaPriorityAssignedSelbriWithoutTerminalRelativeSyntax(_SyntaxNode):
    ...
    def __new__(cls, selbri: ZantufaAssignedSelbriWithoutTerminalRelativeSyntax) -> ZantufaPriorityAssignedSelbriWithoutTerminalRelativeSyntax:
        return cls._from_fields((selbri,))
    def __init__(self, selbri: ZantufaAssignedSelbriWithoutTerminalRelativeSyntax) -> None:
        pass
    @property
    def selbri(self) -> ZantufaAssignedSelbriWithoutTerminalRelativeSyntax:
        ...
        return cast(ZantufaAssignedSelbriWithoutTerminalRelativeSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaPriorityAssignedSelbriWithoutTerminalRelativeSyntax is final')
...
class TaggedSelbriWithoutTerminalRelativeSyntax(_SyntaxNode):
    ...
    def __init__(self, tense_modal: TenseModalSyntax, inner_selbri: UntaggedSelbriWithoutTerminalRelativeSyntax) -> None:
        pass
    @property
    def tense_modal(self) -> TenseModalSyntax:
    ...
    def inner_selbri(self) -> UntaggedSelbriWithoutTerminalRelativeSyntax:
        ...
        return cast(UntaggedSelbriWithoutTerminalRelativeSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('TaggedSelbriWithoutTerminalRelativeSyntax is final')
...
class UntaggedSelbriWithoutTerminalRelativeSyntaxNegatedSelbriWithoutTerminalRelative(_SyntaxNode):
    ...
    def __init__(self, negated_selbri_without_terminal_relative: NegatedSelbriWithoutTerminalRelativeSyntax) -> None:
        pass
    @property
    def negated_selbri_without_terminal_relative(self) -> NegatedSelbriWithoutTerminalRelativeSyntax:
        'NA followed by another restricted selbri.'
        return cast(NegatedSelbriWithoutTerminalRelativeSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('UntaggedSelbriWithoutTerminalRelativeSyntaxNegatedSelbriWithoutTerminalRelative is final')
...
class UntaggedSelbriWithoutTerminalRelativeSyntaxCoSelbri(_SyntaxNode):
    ...
    def co_selbri(self) -> CoSelbriSyntax:
        ...
        return cast(CoSelbriSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('UntaggedSelbriWithoutTerminalRelativeSyntaxCoSelbri is final')
...
class NegatedSelbriWithoutTerminalRelativeSyntax(_SyntaxNode):
    ...
    def __init__(self, na: WithFreeModifiers[Token, FreeModifierSyntax], inner_selbri: SelbriWithoutTerminalRelativeSyntax) -> None:
        pass
    @property
    def na(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The NA marker.'
    ...
    def inner_selbri(self) -> SelbriWithoutTerminalRelativeSyntax:
        ...
        return cast(SelbriWithoutTerminalRelativeSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('NegatedSelbriWithoutTerminalRelativeSyntax is final')
...
class ZantufaSelbriAssignmentSyntax(_SyntaxNode):
    ...
    def __init__(self, cei: WithFreeModifiers[Token, FreeModifierSyntax], selbri: SelbriSyntax) -> None:
        pass
    @property
    ...
    def selbri(self) -> SelbriSyntax:
        ...
        return cast(SelbriSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaSelbriAssignmentSyntax is final')
...
class ZantufaSelbriAssignmentWithoutTerminalRelativeSyntax(_SyntaxNode):
    ...
    def __new__(cls, cei: WithFreeModifiers[Token, FreeModifierSyntax], selbri: SelbriWithoutTerminalRelativeSyntax) -> ZantufaSelbriAssignmentWithoutTerminalRelativeSyntax:
        return cls._from_fields((cei, selbri))
    def __init__(self, cei: WithFreeModifiers[Token, FreeModifierSyntax], selbri: SelbriWithoutTerminalRelativeSyntax) -> None:
        pass
    @property
    def cei(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The warning-bearing CEI marker.'
    ...
    def selbri(self) -> SelbriWithoutTerminalRelativeSyntax:
        ...
        return cast(SelbriWithoutTerminalRelativeSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaSelbriAssignmentWithoutTerminalRelativeSyntax is final')
...
class CoSelbriSyntax(_SyntaxNode):
    ...
    def __init__(self, leading_selbri: TanruSelbriSyntax, co_tail: CoSelbriTailSyntax | None) -> None:
        pass
    @property
...
class TanruSelbriSyntax(_SyntaxNode):
    ...
    def __init__(self, first_selbri: ConnectedSelbriSyntax, additional_selbri: Sequence[ConnectedSelbriSyntax]) -> None:
        pass
    @property
    ...
    def additional_selbri(self) -> tuple[ConnectedSelbriSyntax, ...]:
        ...
        return cast(tuple[ConnectedSelbriSyntax, ...], self._field(1))
    def __init_subclass__(cls) -> None:
...
class ConnectedSelbriSyntax(_SyntaxNode):
    ...
    def __init__(self, leading_selbri: BoundSelbriSyntax, continuations: Sequence[ConnectedSelbriContinuationSyntax]) -> None:
        pass
    @property
    def leading_selbri(self) -> BoundSelbriSyntax:
        'The first level-5 selbri.'
        return cast(BoundSelbriSyntax, self._field(0))
    @property
...
class ConnectedSelbriContinuationSyntaxSimpleConnectedSelbriContinuation(_SyntaxNode):
    ...
    def __init__(self, simple_connected_selbri_continuation: SimpleConnectedSelbriContinuationSyntax) -> None:
        pass
    @property
    def simple_connected_selbri_continuation(self) -> SimpleConnectedSelbriContinuationSyntax:
        'An ordinary joik/jek continuation whose operand is level 5.'
        return cast(SimpleConnectedSelbriContinuationSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ConnectedSelbriContinuationSyntaxSimpleConnectedSelbriContinuation is final')
...
class ConnectedSelbriContinuationSyntaxGroupedConnectedSelbriContinuation(_SyntaxNode):
    ...
    def __init__(self, grouped_connected_selbri_continuation: GroupedConnectedSelbriContinuationSyntax) -> None:
        pass
    @property
    def grouped_connected_selbri_continuation(self) -> GroupedConnectedSelbriContinuationSyntax:
        'The joik-only tagged KE continuation from camxes selbri level 4.'
        return cast(GroupedConnectedSelbriContinuationSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ConnectedSelbriContinuationSyntaxGroupedConnectedSelbriContinuation is final')
...
class SimpleConnectedSelbriContinuationSyntax(_SyntaxNode):
    ...
    def __init__(self, connective: SelbriAfterthoughtConnectiveSyntax, trailing_selbri: BoundSelbriSyntax) -> None:
        pass
    @property
    def connective(self) -> SelbriAfterthoughtConnectiveSyntax:
        'The standard joik/jek selbri connective.'
        return cast(SelbriAfterthoughtConnectiveSyntax, self._field(0))
    @property
    def trailing_selbri(self) -> BoundSelbriSyntax:
        'The following level-5 selbri.'
        return cast(BoundSelbriSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('SimpleConnectedSelbriContinuationSyntax is final')
...
class GroupedConnectedSelbriContinuationSyntax(_SyntaxNode):
    ...
    def __new__(cls, connective: JoikConnectiveSyntax, tense_modal: TenseModalSyntax | None, ke: WithFreeModifiers[Token, FreeModifierSyntax], inner_selbri: TanruSelbriSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> GroupedConnectedSelbriContinuationSyntax:
        return cls._from_fields((connective, tense_modal, ke, inner_selbri, kehe))
    def __init__(self, connective: JoikConnectiveSyntax, tense_modal: TenseModalSyntax | None, ke: WithFreeModifiers[Token, FreeModifierSyntax], inner_selbri: TanruSelbriSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def connective(self) -> JoikConnectiveSyntax:
    ...
    def inner_selbri(self) -> TanruSelbriSyntax:
        ...
        return cast(TanruSelbriSyntax, self._field(3))
    @property
    def kehe(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        'The optional KEhE group terminator.'
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(4))
    def __init_subclass__(cls) -> None:
        raise TypeError('GroupedConnectedSelbriContinuationSyntax is final')
...
class BoundSelbriSyntax(_SyntaxNode):
    ...
    def __init__(self, leading_selbri: PlainBoSelbriSyntax, bo_tail: BoundSelbriTailSyntax | None) -> None:
        pass
    @property
    def leading_selbri(self) -> PlainBoSelbriSyntax:
        'The leading level-6 selbri.'
        return cast(PlainBoSelbriSyntax, self._field(0))
    @property
    def bo_tail(self) -> BoundSelbriTailSyntax | None:
        'The optional, necessarily connective-bearing BO continuation.'
        return cast(BoundSelbriTailSyntax | None, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundSelbriSyntax is final')
...
class BoundSelbriTailSyntax(_SyntaxNode):
    ...
    def __new__(cls, connective: SelbriAfterthoughtConnectiveSyntax, tense_modal: TenseModalSyntax | None, bo: WithFreeModifiers[Token, FreeModifierSyntax], trailing_selbri: BoundSelbriSyntax) -> BoundSelbriTailSyntax:
        return cls._from_fields((connective, tense_modal, bo, trailing_selbri))
    def __init__(self, connective: SelbriAfterthoughtConnectiveSyntax, tense_modal: TenseModalSyntax | None, bo: WithFreeModifiers[Token, FreeModifierSyntax], trailing_selbri: BoundSelbriSyntax) -> None:
        pass
    @property
    def connective(self) -> SelbriAfterthoughtConnectiveSyntax:
    ...
    def trailing_selbri(self) -> BoundSelbriSyntax:
        ...
        return cast(BoundSelbriSyntax, self._field(3))
    def __init_subclass__(cls) -> None:
...
class PlainBoSelbriSyntaxPlainBoTanruUnit(_SyntaxNode):
    ...
    def __init__(self, plain_bo_tanru_unit: PlainBoTanruUnitSyntax) -> None:
        pass
    @property
    def plain_bo_tanru_unit(self) -> PlainBoTanruUnitSyntax:
        'A CEI-capable tanru unit with an optional plain BO continuation.'
        return cast(PlainBoTanruUnitSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('PlainBoSelbriSyntaxPlainBoTanruUnit is final')
...
class PlainBoTanruUnitSyntax(_SyntaxNode):
    ...
    def __init__(self, leading_unit: TanruUnitSyntax, bo_tail: PlainBoSelbriTailSyntax | None) -> None:
        pass
    @property
    ...
    def bo_tail(self) -> PlainBoSelbriTailSyntax | None:
        ...
        return cast(PlainBoSelbriTailSyntax | None, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('PlainBoTanruUnitSyntax is final')
...
class PlainBoSelbriTailSyntax(_SyntaxNode):
    ...
    def __init__(self, bo: WithFreeModifiers[Token, FreeModifierSyntax], trailing_selbri: PlainBoSelbriSyntax) -> None:
        pass
    @property
    def bo(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The BO marker.'
    ...
    def trailing_selbri(self) -> PlainBoSelbriSyntax:
        ...
        return cast(PlainBoSelbriSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('PlainBoSelbriTailSyntax is final')
...
class ForethoughtSelbriConnectionSyntaxZantufaNaryForethoughtSelbriConnection(_SyntaxNode):
    ...
    def __init__(self, zantufa_nary_forethought_selbri_connection: ZantufaNaryForethoughtSelbriConnectionSyntax) -> None:
        pass
    @property
    def zantufa_nary_forethought_selbri_connection(self) -> ZantufaNaryForethoughtSelbriConnectionSyntax:
        'A Zantufa forethought with at least two GI branches.'
        return cast(ZantufaNaryForethoughtSelbriConnectionSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ForethoughtSelbriConnectionSyntaxZantufaNaryForethoughtSelbriConnection is final')
...
class ForethoughtSelbriConnectionSyntaxZantufaGihiForethoughtSelbriConnection(_SyntaxNode):
    ...
    def __init__(self, zantufa_gihi_forethought_selbri_connection: ZantufaGihiForethoughtSelbriConnectionSyntax) -> None:
        pass
    @property
    def zantufa_gihi_forethought_selbri_connection(self) -> ZantufaGihiForethoughtSelbriConnectionSyntax:
        'A Zantufa forethought whose explicit GIhI is its disjointness marker.'
        return cast(ZantufaGihiForethoughtSelbriConnectionSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ForethoughtSelbriConnectionSyntaxZantufaGihiForethoughtSelbriConnection is final')
...
class ForethoughtSelbriConnectionSyntaxStandardForethoughtSelbriConnection(_SyntaxNode):
    ...
    def __init__(self, standard_forethought_selbri_connection: StandardForethoughtSelbriConnectionSyntax) -> None:
        pass
    @property
    def standard_forethought_selbri_connection(self) -> StandardForethoughtSelbriConnectionSyntax:
        'The standard binary L6 owner.'
        return cast(StandardForethoughtSelbriConnectionSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('ForethoughtSelbriConnectionSyntaxStandardForethoughtSelbriConnection is final')
...
class StandardForethoughtSelbriConnectionSyntax(_SyntaxNode):
    ...
    def __new__(cls, nahe: Token | None, free_modifiers: Sequence[FreeModifierSyntax], guhek: GuhekConnectiveSyntax, leading_selbri: SelbriSyntax, first_branch: ForethoughtSelbriBranchSyntax) -> StandardForethoughtSelbriConnectionSyntax:
        return cls._from_fields((nahe, free_modifiers, guhek, leading_selbri, first_branch))
    def __init__(self, nahe: Token | None, free_modifiers: Sequence[FreeModifierSyntax], guhek: GuhekConnectiveSyntax, leading_selbri: SelbriSyntax, first_branch: ForethoughtSelbriBranchSyntax) -> None:
        pass
    @property
    ...
    def guhek(self) -> GuhekConnectiveSyntax:
        ...
        return cast(GuhekConnectiveSyntax, self._field(2))
    @property
    ...
    def first_branch(self) -> ForethoughtSelbriBranchSyntax:
        ...
        return cast(ForethoughtSelbriBranchSyntax, self._field(4))
    def __init_subclass__(cls) -> None:
        raise TypeError('StandardForethoughtSelbriConnectionSyntax is final')
...
class ForethoughtSelbriBranchSyntax(_SyntaxNode):
    ...
    def __init__(self, gik: GikConnectiveSyntax, selbri: PlainBoSelbriSyntax) -> None:
        pass
    @property
    def gik(self) -> GikConnectiveSyntax:
...
class ZantufaFirstForethoughtSelbriBranchSyntax(_SyntaxNode):
    ...
    def __new__(cls, gik: GikConnectiveSyntax, selbri: CoSelbriSyntax) -> ZantufaFirstForethoughtSelbriBranchSyntax:
        return cls._from_fields((gik, selbri))
    def __init__(self, gik: GikConnectiveSyntax, selbri: CoSelbriSyntax) -> None:
        pass
    @property
    def gik(self) -> GikConnectiveSyntax:
    ...
    def selbri(self) -> CoSelbriSyntax:
        ...
        return cast(CoSelbriSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaFirstForethoughtSelbriBranchSyntax is final')
...
class ZantufaForethoughtSelbriBranchSyntax(_SyntaxNode):
    ...
    def __new__(cls, gik: ZantufaExtraGikConnectiveSyntax, selbri: CoSelbriSyntax) -> ZantufaForethoughtSelbriBranchSyntax:
        return cls._from_fields((gik, selbri))
    def __init__(self, gik: ZantufaExtraGikConnectiveSyntax, selbri: CoSelbriSyntax) -> None:
        pass
    @property
    def gik(self) -> ZantufaExtraGikConnectiveSyntax:
...
class ZantufaNaryForethoughtSelbriConnectionSyntax(_SyntaxNode):
    ...
    def __new__(cls, nahe: Token | None, free_modifiers: Sequence[FreeModifierSyntax], guhek: GuhekConnectiveSyntax, leading_selbri: CoSelbriSyntax, first_branch: ZantufaFirstForethoughtSelbriBranchSyntax, additional_branches: Sequence[ZantufaForethoughtSelbriBranchSyntax], gihi: Token | None) -> ZantufaNaryForethoughtSelbriConnectionSyntax:
        return cls._from_fields((nahe, free_modifiers, guhek, leading_selbri, first_branch, additional_branches, gihi))
    def __init__(self, nahe: Token | None, free_modifiers: Sequence[FreeModifierSyntax], guhek: GuhekConnectiveSyntax, leading_selbri: CoSelbriSyntax, first_branch: ZantufaFirstForethoughtSelbriBranchSyntax, additional_branches: Sequence[ZantufaForethoughtSelbriBranchSyntax], gihi: Token | None) -> None:
        pass
    @property
    def nahe(self) -> Token | None:
        'Optional NAhE preceding the independent free-modifier slot.'
    ...
    def leading_selbri(self) -> CoSelbriSyntax:
        ...
        return cast(CoSelbriSyntax, self._field(3))
    @property
    def first_branch(self) -> ZantufaFirstForethoughtSelbriBranchSyntax:
        'The first wide GI branch.'
        return cast(ZantufaFirstForethoughtSelbriBranchSyntax, self._field(4))
    @property
    def additional_branches(self) -> tuple[ZantufaForethoughtSelbriBranchSyntax, ...]:
        ...
        return cast(tuple[ZantufaForethoughtSelbriBranchSyntax, ...], self._field(5))
    @property
    def gihi(self) -> Token | None:
        'An optional warning-bearing explicit GIhI terminator.'
        return cast(Token | None, self._field(6))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaNaryForethoughtSelbriConnectionSyntax is final')
...
class ZantufaGihiForethoughtSelbriConnectionSyntax(_SyntaxNode):
    ...
    def __new__(cls, nahe: Token | None, free_modifiers: Sequence[FreeModifierSyntax], guhek: GuhekConnectiveSyntax, leading_selbri: CoSelbriSyntax, first_branch: ZantufaFirstForethoughtSelbriBranchSyntax, gihi: WithFreeModifiers[Token, FreeModifierSyntax]) -> ZantufaGihiForethoughtSelbriConnectionSyntax:
        return cls._from_fields((nahe, free_modifiers, guhek, leading_selbri, first_branch, gihi))
    def __init__(self, nahe: Token | None, free_modifiers: Sequence[FreeModifierSyntax], guhek: GuhekConnectiveSyntax, leading_selbri: CoSelbriSyntax, first_branch: ZantufaFirstForethoughtSelbriBranchSyntax, gihi: WithFreeModifiers[Token, FreeModifierSyntax]) -> None:
        pass
    @property
    def nahe(self) -> Token | None:
        'Optional NAhE preceding the independent free-modifier slot.'
    ...
    def gihi(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        ...
        return cast(WithFreeModifiers[Token, FreeModifierSyntax], self._field(5))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaGihiForethoughtSelbriConnectionSyntax is final')
...
class TanruUnitSyntax(_SyntaxNode):
    ...
    def __init__(self, base: LinkedTanruUnitSyntax, assignments: Sequence[ProBridiTanruUnitAssignmentSyntax]) -> None:
        pass
    @property
...
class ProBridiTanruUnitAssignmentSyntax(_SyntaxNode):
    ...
    def __init__(self, cei: WithFreeModifiers[Token, FreeModifierSyntax], tanru_unit: LinkedTanruUnitSyntax) -> None:
        pass
    @property
    def cei(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The CEI marker.'
    ...
    def tanru_unit(self) -> LinkedTanruUnitSyntax:
        ...
        return cast(LinkedTanruUnitSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
...
class TanruUnitAtomBaseSyntaxZantufaKeCoGroupedTanruUnit(_SyntaxNode):
    ...
    def __init__(self, zantufa_ke_co_grouped_tanru_unit: ZantufaKeCoGroupedTanruUnitSyntax) -> None:
        pass
    @property
    def zantufa_ke_co_grouped_tanru_unit(self) -> ZantufaKeCoGroupedTanruUnitSyntax:
        'Uses a flat Zantufa KE group with one or more direct CO tails.'
        return cast(ZantufaKeCoGroupedTanruUnitSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('TanruUnitAtomBaseSyntaxZantufaKeCoGroupedTanruUnit is final')
...
class ZantufaKeCoGroupedTanruUnitSyntax(_SyntaxNode):
    ...
    def __new__(cls, ke: WithFreeModifiers[Token, FreeModifierSyntax], leading_selbri: TanruSelbriSyntax, co_tails: Sequence[ZantufaKeCoGroupedTanruTailSyntax], kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> ZantufaKeCoGroupedTanruUnitSyntax:
        return cls._from_fields((ke, leading_selbri, co_tails, kehe))
    def __init__(self, ke: WithFreeModifiers[Token, FreeModifierSyntax], leading_selbri: TanruSelbriSyntax, co_tails: Sequence[ZantufaKeCoGroupedTanruTailSyntax], kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def ke(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
    ...
    def co_tails(self) -> tuple[ZantufaKeCoGroupedTanruTailSyntax, ...]:
        ...
        return cast(tuple[ZantufaKeCoGroupedTanruTailSyntax, ...], self._field(2))
    @property
    def kehe(self) -> WithFreeModifiers[Token, FreeModifierSyntax] | None:
        'The optional KEhE group terminator.'
        return cast(WithFreeModifiers[Token, FreeModifierSyntax] | None, self._field(3))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaKeCoGroupedTanruUnitSyntax is final')
...
class ZantufaKeCoGroupedTanruTailSyntax(_SyntaxNode):
    ...
    def __new__(cls, co: WithFreeModifiers[Token, FreeModifierSyntax], trailing_selbri: TanruSelbriSyntax) -> ZantufaKeCoGroupedTanruTailSyntax:
        return cls._from_fields((co, trailing_selbri))
    def __init__(self, co: WithFreeModifiers[Token, FreeModifierSyntax], trailing_selbri: TanruSelbriSyntax) -> None:
        pass
    @property
    def co(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The CO marker.'
    ...
    def trailing_selbri(self) -> TanruSelbriSyntax:
        ...
        return cast(TanruSelbriSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ZantufaKeCoGroupedTanruTailSyntax is final')
...
class OperatorSelbriTanruUnitSyntax(_SyntaxNode):
    ...
    def __init__(self, nuha: WithFreeModifiers[Token, FreeModifierSyntax], mekso_operator: AtomicMeksoOperatorSyntax) -> None:
        pass
    @property
...
class GroupedTanruUnitSyntax(_SyntaxNode):
    ...
    def __new__(cls, ke: WithFreeModifiers[Token, FreeModifierSyntax], selbri: TanruSelbriSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> GroupedTanruUnitSyntax:
        return cls._from_fields((ke, selbri, kehe))
    def __init__(self, ke: WithFreeModifiers[Token, FreeModifierSyntax], selbri: TanruSelbriSyntax, kehe: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
    def ke(self) -> WithFreeModifiers[Token, FreeModifierSyntax]:
        'The `Ke` cmavo marker.'
...
class LinkedTermSyntaxConnectedLinkedTerm(_SyntaxNode):
    ...
    def __init__(self, connected_linked_term: ConnectedLinkedTermSyntax) -> None:
        pass
    @property
    def connected_linked_term(self) -> ConnectedLinkedTermSyntax:
        'Uses a hierarchy-only loose connection over BO-bound linked terms.'
        return cast(ConnectedLinkedTermSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
...
class LinkedTermSyntaxBoundLinkedTermConnection(_SyntaxNode):
    ...
    def __init__(self, bound_linked_term_connection: BoundLinkedTermConnectionSyntax) -> None:
        pass
    @property
    def bound_linked_term_connection(self) -> BoundLinkedTermConnectionSyntax:
        'Uses a hierarchy-only BO-bound linked-term connection.'
        return cast(BoundLinkedTermConnectionSyntax, self._field(0))
    def __init_subclass__(cls) -> None:
...
class ConnectedLinkedTermSyntax(_SyntaxNode):
    ...
    def __init__(self, leading_link: BoundLinkedTermSyntax, continuations: Sequence[ConnectedLinkedTermContinuationSyntax]) -> None:
        pass
    @property
    def leading_link(self) -> BoundLinkedTermSyntax:
        'The first BO-bound linked term at the loose precedence level.'
        return cast(BoundLinkedTermSyntax, self._field(0))
    @property
    def continuations(self) -> tuple[ConnectedLinkedTermContinuationSyntax, ...]:
        ...
        return cast(tuple[ConnectedLinkedTermContinuationSyntax, ...], self._field(1))
    def __init_subclass__(cls) -> None:
...
class ConnectedLinkedTermContinuationSyntax(_SyntaxNode):
    ...
    def __init__(self, connective: ConnectedTermConnectiveSyntax, trailing_link: BoundLinkedTermSyntax) -> None:
        pass
    @property
    def connective(self) -> ConnectedTermConnectiveSyntax:
    ...
    def trailing_link(self) -> BoundLinkedTermSyntax:
        ...
        return cast(BoundLinkedTermSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
...
class BoundLinkedTermConnectionSyntax(_SyntaxNode):
    ...
    def __new__(cls, leading_link: BoundLinkedTermOperandSyntax, continuations: Sequence[BoundLinkedTermContinuationSyntax]) -> BoundLinkedTermConnectionSyntax:
        return cls._from_fields((leading_link, continuations))
    def __init__(self, leading_link: BoundLinkedTermOperandSyntax, continuations: Sequence[BoundLinkedTermContinuationSyntax]) -> None:
        pass
    @property
    def leading_link(self) -> BoundLinkedTermOperandSyntax:
        'The first nonempty linked argument at the BO-bound precedence level.'
        return cast(BoundLinkedTermOperandSyntax, self._field(0))
    @property
    def continuations(self) -> tuple[BoundLinkedTermContinuationSyntax, ...]:
        'The nonempty source-ordered BO-bound continuation sequence.'
        return cast(tuple[BoundLinkedTermContinuationSyntax, ...], self._field(1))
    def __init_subclass__(cls) -> None:
...
class BoundLinkedTermContinuationSyntax(_SyntaxNode):
    ...
    def __init__(self, connective: BoundTermConnectiveSyntax, tense_modal: TenseModalSyntax | None, bo: WithFreeModifiers[Token, FreeModifierSyntax], trailing_link: BoundLinkedTermOperandSyntax) -> None:
        pass
    @property
    def connective(self) -> BoundTermConnectiveSyntax:
    ...
    def trailing_link(self) -> BoundLinkedTermOperandSyntax:
        ...
        return cast(BoundLinkedTermOperandSyntax, self._field(3))
    def __init_subclass__(cls) -> None:
...
class BeiLinkSyntax(_SyntaxNode):
    ...
    def __init__(self, bei: WithFreeModifiers[Token, FreeModifierSyntax], link: LinkedTermSyntax) -> None:
        pass
    @property
    ...
    def link(self) -> LinkedTermSyntax:
        ...
        return cast(LinkedTermSyntax, self._field(1))
    def __init_subclass__(cls) -> None:
...
class LinkargsSyntax(_SyntaxNode):
    ...
    def __init__(self, be: WithFreeModifiers[Token, FreeModifierSyntax], first_link: LinkedTermSyntax, bei_links: Sequence[BeiLinkSyntax], beho: WithFreeModifiers[Token, FreeModifierSyntax] | None) -> None:
        pass
    @property
...
__all__ = (
    ...
    'SimpleTermSyntaxElidedNaheFihoTagTerm',
    ...
    'VuhoSumtiAttachmentTailSyntaxExperimentalVuhoScopedSumtiAttachmentTail',
    'VuhoSumtiAttachmentTailSyntaxVuhoRelativeSumtiAttachmentTail',
    'VuhoSumtiAttachmentTailSyntaxExperimentalBareVuhoSumtiAttachmentTail',
    'VuhoSumtiAttachmentTailSyntax',
    'VuhoRelativeSumtiAttachmentTailSyntax',
    'ExperimentalVuhoScopedSumtiAttachmentTailSyntax',
    'ExperimentalBareVuhoSumtiAttachmentTailSyntax',
    'SimpleSumtiSyntax',
    ...
    'MeksoOperatorSyntax',
    'MeksoOperatorContinuationSyntaxAfterthoughtMeksoOperatorContinuation',
    'MeksoOperatorContinuationSyntaxGroupedMeksoOperatorContinuation',
    'MeksoOperatorContinuationSyntax',
    'AfterthoughtMeksoOperatorContinuationSyntax',
    'GroupedMeksoOperatorContinuationSyntax',
    'InnerMeksoOperatorSyntaxForethoughtMeksoOperator',
    'InnerMeksoOperatorSyntaxBoundMeksoOperator',
    'InnerMeksoOperatorSyntaxSimpleMeksoOperator',
    'InnerMeksoOperatorSyntax',
    'BoundMeksoOperatorSyntax',
    'SimpleMeksoOperatorSyntaxAtomicMeksoOperator',
    'SimpleMeksoOperatorSyntaxGroupedMeksoOperator',
    'SimpleMeksoOperatorSyntax',
    'AtomicMeksoOperatorSyntaxConvertedMeksoOperator',
    'AtomicMeksoOperatorSyntaxScalarNegatedMeksoOperator',
    'AtomicMeksoOperatorSyntaxSelbriMeksoOperator',
    'AtomicMeksoOperatorSyntaxOperandMeksoOperator',
    'AtomicMeksoOperatorSyntaxExperimentalConnectiveMeksoOperator',
    'AtomicMeksoOperatorSyntaxPrimitiveMeksoOperator',
    ...
    'ExperimentalConnectiveMeksoOperatorSyntaxStandardStatementConnective',
    'ExperimentalConnectiveMeksoOperatorSyntaxEkConnective',
    'ExperimentalConnectiveMeksoOperatorSyntax',
    'MeksoOperandSyntax',
    ...
    'SimpleMeksoOperandSyntaxScalarNegatedMeksoOperand',
    'SimpleMeksoOperandSyntaxLaheQualifiedMeksoOperand',
    ...
    'StandardMeksoArrayElementSyntaxMeksoOperand',
    'StandardMeksoArrayElementSyntaxForethoughtCallMekso',
    'StandardMeksoArrayElementSyntax',
    'LetterStringSyntax',
    ...
    'MeksoSyntaxReinterpretZantufaMex',
    'MeksoSyntaxZantufaPriorityMex',
    'MeksoSyntaxInfixMekso',
    'MeksoSyntaxReversePolishMekso',
    'MeksoSyntaxZantufaMex',
    'MeksoSyntax',
    'ZantufaPriorityMexSyntax',
    'ReinterpretZantufaMexSyntax',
    'ZantufaMexSyntax',
    'ZantufaMexContinuationSyntax',
    'ZantufaMex1Syntax',
    'ZantufaMexGroupSyntaxZantufaKeGroupedMekso',
    'ZantufaMexGroupSyntaxZantufaBoGroupedMekso',
    'ZantufaMexGroupSyntax',
    'ZantufaKeGroupedMeksoSyntax',
    'ZantufaBoGroupedMeksoSyntax',
    'ZantufaBoGroupedMeksoContinuationSyntax',
    'ZantufaBiheMeksoTailSyntax',
    'ZantufaMex2SyntaxZantufaOperand',
    'ZantufaMex2SyntaxZantufaReversePolishMekso',
    'ZantufaMex2SyntaxZantufaForethoughtMekso',
    'ZantufaMex2Syntax',
    'ZantufaReversePolishMeksoSyntax',
    'ZantufaReversePolishTailSyntax',
    'ZantufaForethoughtMeksoSyntax',
    'ZantufaOperandSyntaxNumberMekso',
    'ZantufaOperandSyntaxLerfuStringMekso',
    'ZantufaOperandSyntaxZantufaParenthesizedMeksoOperand',
    'ZantufaOperandSyntaxZantufaSelbriMoheMeksoOperand',
    'ZantufaOperandSyntaxZantufaSumtiMoheMeksoOperand',
    'ZantufaOperandSyntaxZantufaLaheQualifiedMeksoOperand',
    'ZantufaOperandSyntaxZantufaNaheBoQualifiedMeksoOperand',
    'ZantufaOperandSyntaxZantufaScalarNegatedMeksoOperand',
    'ZantufaOperandSyntax',
    ...
    'ZantufaOperatorSyntaxZantufaConvertedMeksoOperator',
    'ZantufaOperatorSyntaxZantufaScalarNegatedMeksoOperator',
    'ZantufaOperatorSyntaxZantufaMahoMeksoOperator',
    'ZantufaOperatorSyntaxZantufaMahoSelbriMeksoOperator',
    'ZantufaOperatorSyntaxZantufaMahoSumtiMeksoOperator',
    'ZantufaOperatorSyntaxZantufaPrimitiveMeksoOperator',
    'ZantufaOperatorSyntaxZantufaConnectiveMeksoOperator',
    'ZantufaOperatorSyntax',
    'ZantufaConvertedMeksoOperatorSyntax',
    'ZantufaScalarNegatedMeksoOperatorSyntax',
    'ZantufaMahoMeksoOperatorSyntax',
    'ZantufaPrimitiveMeksoOperatorSyntax',
    ...
    'RelativeClauseTailSyntaxRelativeClauseExpContinuation',
    'RelativeClauseTailSyntaxJoinedRelativeClauseTail',
    'RelativeClauseTailSyntaxZantufaBareRelativeClauseTail',
    'RelativeClauseTailSyntax',
    'ZantufaBareRelativeClauseTailSyntax',
    'RelativeClauseExpContinuationSyntax',
    'JoinedRelativeClauseTailSyntax',
    'ExpRelativeContinuationSyntax',
    ...
    'JoikConnectiveSyntaxZantufaGahoJoikConnective',
    'JoikConnectiveSyntaxZantufaRightGahoJoikConnective',
    'JoikConnectiveSyntaxZantufaNaJoikConnective',
    ...
    'SumtiConnectiveSyntaxJoikConnective',
    'SumtiConnectiveSyntaxEkConnective',
    'SumtiConnectiveSyntaxJehiConnective',
    'SumtiConnectiveSyntaxExperimentalVuhuSumtiConnective',
    'SumtiConnectiveSyntax',
    'ExperimentalVuhuSumtiConnectiveSyntax',
    ...
    'SelbriAfterthoughtConnectiveSyntaxJoikConnective',
    'SelbriAfterthoughtConnectiveSyntaxJekConnective',
    'SelbriAfterthoughtConnectiveSyntax',
    ...
    'ParagraphStandardStatementConnectiveSyntaxParagraphZantufaGahoJoikConnective',
    'ParagraphStandardStatementConnectiveSyntaxParagraphZantufaRightGahoJoikConnective',
    'ParagraphStandardStatementConnectiveSyntaxParagraphZantufaNaJoikConnective',
    ...
    'ModalForethoughtConnectiveSyntaxZantufaGaBoForethoughtConnective',
    ...
    'ModalForethoughtConnectiveSyntaxZantufaModalGiBoForethoughtConnective',
    ...
    'ModalForethoughtConnectiveSyntaxZantufaInitialGiTagForethoughtConnective',
    'ModalForethoughtConnectiveSyntax',
    ...
    'ModalTenseSyntax',
    'StickyTenseSyntax',
    'SelbriSyntaxReinterpretZantufaAssignedSelbri',
    'SelbriSyntaxZantufaRelativeSelbri',
    'SelbriSyntaxZantufaPriorityAssignedSelbri',
    'SelbriSyntaxTaggedSelbri',
    'SelbriSyntaxUntaggedSelbri',
    'SelbriSyntax',
    'ReinterpretZantufaAssignedSelbriSyntax',
    'ZantufaRelativeSelbriSyntax',
    'ZantufaPriorityAssignedSelbriSyntax',
    'ZantufaAssignedSelbriSyntax',
    'ZantufaAssignedSelbriWithoutTerminalRelativeSyntax',
    'SelbriWithoutTerminalRelativeSyntaxZantufaPriorityAssignedSelbriWithoutTerminalRelative',
    'SelbriWithoutTerminalRelativeSyntaxTaggedSelbriWithoutTerminalRelative',
    'SelbriWithoutTerminalRelativeSyntaxUntaggedSelbriWithoutTerminalRelative',
    'SelbriWithoutTerminalRelativeSyntax',
    'ZantufaPriorityAssignedSelbriWithoutTerminalRelativeSyntax',
    'TaggedSelbriWithoutTerminalRelativeSyntax',
    'UntaggedSelbriWithoutTerminalRelativeSyntaxNegatedSelbriWithoutTerminalRelative',
    'UntaggedSelbriWithoutTerminalRelativeSyntaxCoSelbri',
    'UntaggedSelbriWithoutTerminalRelativeSyntax',
    'NegatedSelbriWithoutTerminalRelativeSyntax',
    'ZantufaSelbriAssignmentSyntax',
    'ZantufaSelbriAssignmentWithoutTerminalRelativeSyntax',
    ...
    'ConnectedSelbriContinuationSyntaxSimpleConnectedSelbriContinuation',
    'ConnectedSelbriContinuationSyntaxGroupedConnectedSelbriContinuation',
    'ConnectedSelbriContinuationSyntax',
    'SimpleConnectedSelbriContinuationSyntax',
    ...
    'ForethoughtSelbriConnectionSyntaxZantufaGihiForethoughtSelbriConnection',
    'ForethoughtSelbriConnectionSyntaxStandardForethoughtSelbriConnection',
    'ForethoughtSelbriConnectionSyntax',
    'StandardForethoughtSelbriConnectionSyntax',
    'ForethoughtSelbriBranchSyntax',
    'ZantufaFirstForethoughtSelbriBranchSyntax',
    ...
    'ZantufaKeCoGroupedTanruTailSyntax',
