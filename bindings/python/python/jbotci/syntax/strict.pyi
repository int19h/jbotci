...
class TanruUnitAtomBaseSyntaxZantufaFaTanruUnit:
    ...
    def __new__(cls, zantufa_fa_tanru_unit_candidate: ZantufaFaTanruUnitSyntax) -> TanruUnitAtomBaseSyntaxZantufaFaTanruUnit: ...
    @property
    def zantufa_fa_tanru_unit_candidate(self) -> ZantufaFaTanruUnitSyntax:
        'A fully proven source FA prefix over a shared inner atom.'
        ...
    __hash__: ClassVar[None]  # type: ignore[assignment]
    def same_identity(self, other: object, /) -> bool: ...
