...
class ZantufaRecursiveTagTenseSyntax:
    ...
    def __new__(
        cls,
        first_prefix: WithFreeModifiers[Token, FreeModifierSyntax],
        additional_prefixes: Sequence[WithFreeModifiers[Token, FreeModifierSyntax]],
        atom: WithFreeModifiers[Token, FreeModifierSyntax],
