...
@final
class PeheTermsetOperandSyntaxStagBoundTermConnection(_SyntaxNode):
    ...
    def __init__(self, stag_bound_term_connection: RecoveredField[StagBoundTermConnectionSyntax]) -> None:
        pass
    @property
    def stag_bound_term_connection(self) -> RecoveredField[StagBoundTermConnectionSyntax]:
        'Uses the `stag_bound_term_connection` product form, whose payload preserves `leading_term` and `continuations`.'
        return cast(RecoveredField[StagBoundTermConnectionSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('PeheTermsetOperandSyntaxStagBoundTermConnection is final')
...
class BoundTermSyntaxStagBoundTermConnection(_SyntaxNode):
    ...
    def stag_bound_term_connection(self) -> RecoveredField[StagBoundTermConnectionSyntax]:
        ...
        return cast(RecoveredField[StagBoundTermConnectionSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundTermSyntaxStagBoundTermConnection is final')
...
class BoundTermSyntaxPlaceTaggedSumtiTerm(_SyntaxNode):
    ...
    def place_tagged_sumti_term(self) -> RecoveredField[PlaceTaggedSumtiTermSyntax]:
        ...
        return cast(RecoveredField[PlaceTaggedSumtiTermSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundTermSyntaxPlaceTaggedSumtiTerm is final')
...
class BoundTermSyntaxJaiTaggedSumtiTerm(_SyntaxNode):
    ...
    def jai_tagged_sumti_term(self) -> RecoveredField[JaiTaggedSumtiTermSyntax]:
        ...
        return cast(RecoveredField[JaiTaggedSumtiTermSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundTermSyntaxJaiTaggedSumtiTerm is final')
...
class BoundTermSyntaxTaggedSumtiBeforeTagTerm(_SyntaxNode):
    ...
    def tagged_sumti_before_tag_term(self) -> RecoveredField[TaggedSumtiBeforeTagTermSyntax]:
        ...
        return cast(RecoveredField[TaggedSumtiBeforeTagTermSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundTermSyntaxTaggedSumtiBeforeTagTerm is final')
...
class BoundTermSyntaxTaggedSumtiTerm(_SyntaxNode):
    ...
    def tagged_sumti_term(self) -> RecoveredField[TaggedSumtiTermSyntax]:
        ...
        return cast(RecoveredField[TaggedSumtiTermSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundTermSyntaxTaggedSumtiTerm is final')
...
class BoundTermSyntaxNaKuTerm(_SyntaxNode):
    ...
    def na_ku_term(self) -> RecoveredField[NaKuTermSyntax]:
        ...
        return cast(RecoveredField[NaKuTermSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundTermSyntaxNaKuTerm is final')
...
class BoundTermSyntaxSumtiTerm(_SyntaxNode):
    ...
    def sumti_term(self) -> RecoveredField[SumtiTermSyntax]:
        ...
        return cast(RecoveredField[SumtiTermSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundTermSyntaxSumtiTerm is final')
...
class BoundTermSyntaxBareNaTerm(_SyntaxNode):
    ...
    def bare_na_term(self) -> RecoveredField[BareNaTermSyntax]:
        ...
        return cast(RecoveredField[BareNaTermSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundTermSyntaxBareNaTerm is final')
...
class BoundTermSyntaxForethoughtTermset(_SyntaxNode):
    ...
    def forethought_termset(self) -> RecoveredField[ForethoughtTermsetSyntax]:
        ...
        return cast(RecoveredField[ForethoughtTermsetSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundTermSyntaxForethoughtTermset is final')
...
class BoundTermSyntaxNuhiTermset(_SyntaxNode):
    ...
    def nuhi_termset(self) -> RecoveredField[NuhiTermsetSyntax]:
        ...
        return cast(RecoveredField[NuhiTermsetSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundTermSyntaxNuhiTermset is final')
...
class StagBoundTermConnectionSyntax(_SyntaxNode):
    ...
    def __new__(cls, leading_term: RecoveredField[SimpleTermSyntax], continuations: Sequence[RecoveredField[StagBoundTermContinuationSyntax]]) -> StagBoundTermConnectionSyntax:
        return cls._from_fields((leading_term, continuations))
    def __init__(self, leading_term: RecoveredField[SimpleTermSyntax], continuations: Sequence[RecoveredField[StagBoundTermContinuationSyntax]]) -> None:
        pass
    @property
    ...
    def continuations(self) -> tuple[RecoveredField[StagBoundTermContinuationSyntax], ...]:
        ...
        return cast(tuple[RecoveredField[StagBoundTermContinuationSyntax], ...], self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('StagBoundTermConnectionSyntax is final')
...
class StagBoundTermContinuationSyntax(_SyntaxNode):
    ...
    def __new__(cls, connective: RecoveredField[BoundTermConnectiveSyntax], tense_modal: RecoveredField[TenseModalSyntax], bo: WithFreeModifiers[RecoveredField[Token], RecoveredField[FreeModifierSyntax]], trailing_term: RecoveredField[SimpleTermSyntax]) -> StagBoundTermContinuationSyntax:
        return cls._from_fields((connective, tense_modal, bo, trailing_term))
    def __init__(self, connective: RecoveredField[BoundTermConnectiveSyntax], tense_modal: RecoveredField[TenseModalSyntax], bo: WithFreeModifiers[RecoveredField[Token], RecoveredField[FreeModifierSyntax]], trailing_term: RecoveredField[SimpleTermSyntax]) -> None:
        pass
    @property
    def connective(self) -> RecoveredField[BoundTermConnectiveSyntax]:
        'The connective joining the adjacent simple terms.'
        return cast(RecoveredField[BoundTermConnectiveSyntax], self._field(0))
    @property
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError('StagBoundTermContinuationSyntax is final')
...
class ConnectedTermSyntax(_SyntaxNode):
    ...
    def __new__(cls, leading_term: RecoveredField[BoundTermSyntax], continuations: Sequence[RecoveredField[ConnectedTermContinuationSyntax]]) -> ConnectedTermSyntax:
        return cls._from_fields((leading_term, continuations))
    def __init__(self, leading_term: RecoveredField[BoundTermSyntax], continuations: Sequence[RecoveredField[ConnectedTermContinuationSyntax]]) -> None:
        pass
    @property
    def leading_term(self) -> RecoveredField[BoundTermSyntax]:
        'The shared leading term child syntax node.'
        return cast(RecoveredField[BoundTermSyntax], self._field(0))
    @property
...
class ConnectedTermContinuationSyntax(_SyntaxNode):
    ...
    def __init__(self, connective: RecoveredField[ConnectedTermConnectiveSyntax], trailing_term: RecoveredField[BoundTermSyntax]) -> None:
        pass
    @property
    ...
    def trailing_term(self) -> RecoveredField[BoundTermSyntax]:
        'The shared trailing term child syntax node.'
        return cast(RecoveredField[BoundTermSyntax], self._field(1))
    def __init_subclass__(cls) -> None:
...
class LinkedTermSyntaxConnectedLinkedTerm(_SyntaxNode):
    ...
    def __init__(self, connected_linked_term: RecoveredField[ConnectedLinkedTermSyntax]) -> None:
        pass
    @property
    def connected_linked_term(self) -> RecoveredField[ConnectedLinkedTermSyntax]:
        'Uses a hierarchy-only loose connection over BO-bound linked terms.'
        return cast(RecoveredField[ConnectedLinkedTermSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('LinkedTermSyntaxConnectedLinkedTerm is final')
...
class LinkedTermSyntaxBoundLinkedTermConnection(_SyntaxNode):
    ...
    def __init__(self, bound_linked_term_connection: RecoveredField[BoundLinkedTermConnectionSyntax]) -> None:
        pass
    @property
    def bound_linked_term_connection(self) -> RecoveredField[BoundLinkedTermConnectionSyntax]:
        'Uses a hierarchy-only BO-bound linked-term connection.'
        return cast(RecoveredField[BoundLinkedTermConnectionSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('LinkedTermSyntaxBoundLinkedTermConnection is final')
...
class LinkedTermSyntaxPlaceTaggedLinkedSumti(_SyntaxNode):
    ...
    def place_tagged_linked_sumti(self) -> RecoveredField[PlaceTaggedLinkedSumtiSyntax]:
        ...
        return cast(RecoveredField[PlaceTaggedLinkedSumtiSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('LinkedTermSyntaxPlaceTaggedLinkedSumti is final')
...
class LinkedTermSyntaxTenseTaggedLinkedSumti(_SyntaxNode):
    ...
    def tense_tagged_linked_sumti(self) -> RecoveredField[TenseTaggedLinkedSumtiSyntax]:
        ...
        return cast(RecoveredField[TenseTaggedLinkedSumtiSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('LinkedTermSyntaxTenseTaggedLinkedSumti is final')
...
class ConnectedLinkedTermSyntax(_SyntaxNode):
    ...
    def __init__(self, leading_link: RecoveredField[BoundLinkedTermSyntax], continuations: Sequence[RecoveredField[ConnectedLinkedTermContinuationSyntax]]) -> None:
        pass
    @property
    def leading_link(self) -> RecoveredField[BoundLinkedTermSyntax]:
        'The first BO-bound linked term at the loose precedence level.'
        return cast(RecoveredField[BoundLinkedTermSyntax], self._field(0))
    @property
    def continuations(self) -> tuple[RecoveredField[ConnectedLinkedTermContinuationSyntax], ...]:
        ...
        return cast(tuple[RecoveredField[ConnectedLinkedTermContinuationSyntax], ...], self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ConnectedLinkedTermSyntax is final')
...
class ConnectedLinkedTermContinuationSyntax(_SyntaxNode):
    ...
    def __init__(self, connective: RecoveredField[ConnectedTermConnectiveSyntax], trailing_link: RecoveredField[BoundLinkedTermSyntax]) -> None:
        pass
    @property
    def connective(self) -> RecoveredField[ConnectedTermConnectiveSyntax]:
    ...
    def trailing_link(self) -> RecoveredField[BoundLinkedTermSyntax]:
        ...
        return cast(RecoveredField[BoundLinkedTermSyntax], self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('ConnectedLinkedTermContinuationSyntax is final')
...
class BoundLinkedTermSyntaxBoundLinkedTermConnection(_SyntaxNode):
    ...
    def bound_linked_term_connection(self) -> RecoveredField[BoundLinkedTermConnectionSyntax]:
        ...
        return cast(RecoveredField[BoundLinkedTermConnectionSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundLinkedTermSyntaxBoundLinkedTermConnection is final')
...
class BoundLinkedTermSyntaxPlaceTaggedLinkedSumti(_SyntaxNode):
    ...
    def place_tagged_linked_sumti(self) -> RecoveredField[PlaceTaggedLinkedSumtiSyntax]:
        ...
        return cast(RecoveredField[PlaceTaggedLinkedSumtiSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundLinkedTermSyntaxPlaceTaggedLinkedSumti is final')
...
class BoundLinkedTermSyntaxTenseTaggedLinkedSumti(_SyntaxNode):
    ...
    def tense_tagged_linked_sumti(self) -> RecoveredField[TenseTaggedLinkedSumtiSyntax]:
        ...
        return cast(RecoveredField[TenseTaggedLinkedSumtiSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundLinkedTermSyntaxTenseTaggedLinkedSumti is final')
...
class BoundLinkedTermSyntaxPlainLinkedSumti(_SyntaxNode):
    ...
    def plain_linked_sumti(self) -> RecoveredField[PlainLinkedSumtiSyntax]:
        ...
        return cast(RecoveredField[PlainLinkedSumtiSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundLinkedTermSyntaxPlainLinkedSumti is final')
...
class BoundLinkedTermOperandSyntaxPlaceTaggedLinkedSumti(_SyntaxNode):
    ...
    def place_tagged_linked_sumti(self) -> RecoveredField[PlaceTaggedLinkedSumtiSyntax]:
        ...
        return cast(RecoveredField[PlaceTaggedLinkedSumtiSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundLinkedTermOperandSyntaxPlaceTaggedLinkedSumti is final')
...
class BoundLinkedTermOperandSyntaxTenseTaggedLinkedSumti(_SyntaxNode):
    ...
    def tense_tagged_linked_sumti(self) -> RecoveredField[TenseTaggedLinkedSumtiSyntax]:
        ...
        return cast(RecoveredField[TenseTaggedLinkedSumtiSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundLinkedTermOperandSyntaxTenseTaggedLinkedSumti is final')
...
class BoundLinkedTermOperandSyntaxPlainLinkedSumti(_SyntaxNode):
    ...
    def plain_linked_sumti(self) -> RecoveredField[PlainLinkedSumtiSyntax]:
        ...
        return cast(RecoveredField[PlainLinkedSumtiSyntax], self._field(0))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundLinkedTermOperandSyntaxPlainLinkedSumti is final')
...
class BoundLinkedTermConnectionSyntax(_SyntaxNode):
    ...
    def __new__(cls, leading_link: RecoveredField[BoundLinkedTermOperandSyntax], continuations: Sequence[RecoveredField[BoundLinkedTermContinuationSyntax]]) -> BoundLinkedTermConnectionSyntax:
        return cls._from_fields((leading_link, continuations))
    def __init__(self, leading_link: RecoveredField[BoundLinkedTermOperandSyntax], continuations: Sequence[RecoveredField[BoundLinkedTermContinuationSyntax]]) -> None:
        pass
    @property
    def leading_link(self) -> RecoveredField[BoundLinkedTermOperandSyntax]:
        ...
        return cast(RecoveredField[BoundLinkedTermOperandSyntax], self._field(0))
    @property
    def continuations(self) -> tuple[RecoveredField[BoundLinkedTermContinuationSyntax], ...]:
        'The nonempty source-ordered BO-bound continuation sequence.'
        return cast(tuple[RecoveredField[BoundLinkedTermContinuationSyntax], ...], self._field(1))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundLinkedTermConnectionSyntax is final')
...
class BoundLinkedTermContinuationSyntax(_SyntaxNode):
    ...
    def __new__(cls, connective: RecoveredField[BoundTermConnectiveSyntax], tense_modal: RecoveredField[TenseModalSyntax] | None, bo: WithFreeModifiers[RecoveredField[Token], RecoveredField[FreeModifierSyntax]], trailing_link: RecoveredField[BoundLinkedTermOperandSyntax]) -> BoundLinkedTermContinuationSyntax:
        return cls._from_fields((connective, tense_modal, bo, trailing_link))
    def __init__(self, connective: RecoveredField[BoundTermConnectiveSyntax], tense_modal: RecoveredField[TenseModalSyntax] | None, bo: WithFreeModifiers[RecoveredField[Token], RecoveredField[FreeModifierSyntax]], trailing_link: RecoveredField[BoundLinkedTermOperandSyntax]) -> None:
        pass
    @property
    def connective(self) -> RecoveredField[BoundTermConnectiveSyntax]:
    ...
    def trailing_link(self) -> RecoveredField[BoundLinkedTermOperandSyntax]:
        ...
        return cast(RecoveredField[BoundLinkedTermOperandSyntax], self._field(3))
    def __init_subclass__(cls) -> None:
        raise TypeError('BoundLinkedTermContinuationSyntax is final')
...
class BeiLinkSyntax(_SyntaxNode):
    ...
    def __init__(self, bei: WithFreeModifiers[RecoveredField[Token], RecoveredField[FreeModifierSyntax]], link: RecoveredField[LinkedTermSyntax]) -> None:
        pass
    @property
    ...
    def link(self) -> RecoveredField[LinkedTermSyntax]:
        ...
        return cast(RecoveredField[LinkedTermSyntax], self._field(1))
    def __init_subclass__(cls) -> None:
...
class LinkargsSyntax(_SyntaxNode):
    ...
    def __init__(self, be: WithFreeModifiers[RecoveredField[Token], RecoveredField[FreeModifierSyntax]], first_link: RecoveredField[LinkedTermSyntax], bei_links: Sequence[RecoveredField[BeiLinkSyntax]], beho: WithFreeModifiers[RecoveredField[Token], RecoveredField[FreeModifierSyntax]] | None) -> None:
        pass
    @property
...
__all__ = (
    ...
    'PeheTermsetOperandSyntaxStagBoundTermConnection',
    ...
    'SimpleTermSyntaxKeTermset',
    'SimpleTermSyntax',
    'BoundTermSyntaxStagBoundTermConnection',
    'BoundTermSyntaxPlaceTaggedSumtiTerm',
    'BoundTermSyntaxJaiTaggedSumtiTerm',
    'BoundTermSyntaxTaggedSumtiBeforeTagTerm',
    ...
    'BoundTermSyntaxForethoughtTermset',
    'BoundTermSyntaxNuhiTermset',
    'BoundTermSyntaxKeTermset',
    'BoundTermSyntax',
    'StagBoundTermConnectionSyntax',
    ...
    'LinkedTermSyntaxBoundLinkedTermConnection',
    ...
    'ConnectedLinkedTermContinuationSyntax',
    'BoundLinkedTermSyntaxBoundLinkedTermConnection',
    'BoundLinkedTermSyntaxPlaceTaggedLinkedSumti',
    'BoundLinkedTermSyntaxTenseTaggedLinkedSumti',
    'BoundLinkedTermSyntaxPlainLinkedSumti',
    'BoundLinkedTermSyntax',
    'BoundLinkedTermOperandSyntaxPlaceTaggedLinkedSumti',
    'BoundLinkedTermOperandSyntaxTenseTaggedLinkedSumti',
    'BoundLinkedTermOperandSyntaxPlainLinkedSumti',
    'BoundLinkedTermOperandSyntax',
    'BoundLinkedTermConnectionSyntax',
