...
@final
class TenseModalAtomSyntaxNaheSeFlatPrefixedTense:
    'Uses the `nahe_se_flat_prefixed_tense` product form, whose payload preserves `nahe`, `se`, and `atom`.'
    __match_args__: ClassVar[tuple[Literal['nahe_se_flat_prefixed_tense']]]
...
@final
class TenseModalAtomSyntaxSeFlatPrefixedTense:
    'Uses the `se_flat_prefixed_tense` product form, whose payload preserves `se` and `atom`.'
    __match_args__: ClassVar[tuple[Literal['se_flat_prefixed_tense']]]
...
@final
class TenseModalAtomSyntaxFaFlatTagTense:
    'Uses the `fa_flat_tag_tense` product form, whose payload preserves `fa`.'
    __match_args__: ClassVar[tuple[Literal['fa_flat_tag_tense']]]
...
@final
class TenseModalAtomSyntaxZantufaRecursiveTagTense:
    'Uses the `zantufa_recursive_tag_tense` product form, whose payload preserves `first_prefix`, `additional_prefixes`, and `atom`.'
    __match_args__: ClassVar[tuple[Literal['zantufa_recursive_tag_tense']]]
...
@final
class FlatTagAtomSyntaxFaFlatTagAtom:
    'Uses the `fa_flat_tag_atom` product form, whose payload preserves `fa`.'
    __match_args__: ClassVar[tuple[Literal['fa_flat_tag_atom']]]
...
@final
class FlatTagAtomSyntaxModalFlatTagAtom:
    'Uses the `modal_flat_tag_atom` product form, whose payload preserves `modal`.'
    __match_args__: ClassVar[tuple[Literal['modal_flat_tag_atom']]]
...
@final
class FlatTagAtomSyntaxCompositeFlatTagAtom:
    'Uses the `composite_flat_tag_atom` product form, whose payload preserves `composite`.'
    __match_args__: ClassVar[tuple[Literal['composite_flat_tag_atom']]]
...
@final
class ModalFlatTagAtomSyntax:
    'Transparent product node for modal tag; preserves the `modal` component.'
    __match_args__: ClassVar[tuple[Literal['modal']]]
...
@final
class CompositeFlatTagAtomSyntax:
    'Transparent product node for tag; preserves the `composite` component.'
    __match_args__: ClassVar[tuple[Literal['composite']]]
...
@final
class NaheSeFlatPrefixedTenseSyntax:
    ...
    def __new__(
        ...
        atom: RecoveredField[FlatTagAtomSyntax],
...
@final
class SeFlatPrefixedTenseSyntax:
    'Product node for tag; preserves `se` and `atom` in source order.'
    __match_args__: ClassVar[tuple[Literal['se'], Literal['atom']]]
...
@final
class ZantufaRecursiveTagTenseSyntax:
    'Product node for tag; preserves `first_prefix`, `additional_prefixes`, and `atom` in source order.'
    __match_args__: ClassVar[tuple[Literal['first_prefix'], Literal['additional_prefixes'], Literal['atom']]]
    def __new__(
        cls,
        first_prefix: WithFreeModifiers[RecoveredField[Token], RecoveredField[FreeModifierSyntax]],
        additional_prefixes: Sequence[WithFreeModifiers[RecoveredField[Token], RecoveredField[FreeModifierSyntax]]],
        atom: WithFreeModifiers[RecoveredField[Token], RecoveredField[FreeModifierSyntax]],
