...
class GikPairedTermsetOperandsSyntax:
    ...
    def __new__(
        cls,
        leading_operand: RecoveredField[NonabsTermSyntax],
        gik: RecoveredField[GikConnectiveSyntax],
        trailing_operand: RecoveredField[NonabsTermSyntax],
    ) -> GikPairedTermsetOperandsSyntax: ...
    @property
    def leading_operand(self) -> RecoveredField[NonabsTermSyntax]:
    ...
    def gik(self) -> RecoveredField[GikConnectiveSyntax]:
        ...
        ...
    @property
    def trailing_operand(self) -> RecoveredField[NonabsTermSyntax]:
