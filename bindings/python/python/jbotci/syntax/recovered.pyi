...
@final
class TermSyntaxSimpleTerm:
    'Uses the nested `simple_term` sum form and preserves its selected alternative.'
    __match_args__: ClassVar[tuple[Literal['simple_term']]]
...
class PeheTermsetConnectionContinuationSyntax:
    ...
    def __new__(
        ...
        connective: RecoveredField[StatementConnectiveSyntax],
        trailing_term: RecoveredField[PeheTermsetOperandSyntax],
...
@final
class PeheTermsetOperandSyntaxBoundTermConnection:
    'Uses the `bound_term_connection` product form, whose payload preserves `leading_term`, `connective`, `bo`, and `trailing_term`.'
    __match_args__: ClassVar[tuple[Literal['bound_term_connection']]]
...
@final
class PeheTermsetOperandSyntaxStagBoundTermConnection:
    ...
    def __new__(cls, stag_bound_term_connection: RecoveredField[StagBoundTermConnectionSyntax]) -> PeheTermsetOperandSyntaxStagBoundTermConnection: ...
    @property
...
@final
class PeheTermsetOperandSyntaxTermsetGroup:
    'Uses the `termset_group` product form, whose payload preserves `leading_term` and `continuations`.'
    __match_args__: ClassVar[tuple[Literal['termset_group']]]
...
@final
class PeheTermsetOperandSyntaxSimpleTerm:
    'Uses the nested `simple_term` sum form and preserves its selected alternative.'
    __match_args__: ClassVar[tuple[Literal['simple_term']]]
...
PeheTermsetOperandSyntax: TypeAlias = PeheTermsetOperandSyntaxBoundTermConnection | PeheTermsetOperandSyntaxStagBoundTermConnection | PeheTermsetOperandSyntaxTermsetGroup | PeheTermsetOperandSyntaxSimpleTerm
...
class StagBoundTermContinuationSyntax:
    ...
    def __new__(
        cls,
        connective: RecoveredField[BoundTermConnectiveSyntax],
...
@final
class BoundTermConnectionSyntax:
    'Product node for term connection; preserves `leading_term`, `connective`, `bo`, and `trailing_term` in source order.'
    __match_args__: ClassVar[tuple[Literal['leading_term'], Literal['connective'], Literal['bo'], Literal['trailing_term']]]
    def __new__(
        cls,
        leading_term: RecoveredField[SimpleTermSyntax],
        connective: RecoveredField[BoundTermConnectiveSyntax],
        bo: WithFreeModifiers[RecoveredField[Token], RecoveredField[FreeModifierSyntax]],
        trailing_term: RecoveredField[SimpleTermSyntax],
...
@final
class BoundTermConnectiveSyntaxJoikConnective:
...
@final
class BoundTermConnectiveSyntaxEkConnective:
...
class ConnectedTermContinuationSyntax:
    ...
    def __new__(cls, connective: RecoveredField[ConnectedTermConnectiveSyntax], trailing_term: RecoveredField[BoundTermSyntax]) -> ConnectedTermContinuationSyntax: ...
    @property
...
@final
class ConnectedTermConnectiveSyntaxJoikConnective:
    'Uses the nested `joik_connective` sum form and preserves its selected alternative.'
    __match_args__: ClassVar[tuple[Literal['joik_connective']]]
...
@final
class ConnectedTermConnectiveSyntaxJekConnective:
...
@final
class ConnectedTermConnectiveSyntaxEkConnective:
    'Uses the `ek_connective` product form, whose payload preserves `na`, `se`, `a`, and `nai`.'
    __match_args__: ClassVar[tuple[Literal['ek_connective']]]
...
@final
class ConnectedTermConnectiveSyntaxVuhuNonlogicalConnective:
...
class ForethoughtTermsetSyntax:
    ...
    def __new__(
        cls,
        m_nuhi: WithFreeModifiers[RecoveredField[Token], RecoveredField[FreeModifierSyntax]] | None,
        gek: RecoveredField[ModalForethoughtConnectiveSyntax],
        terms: Sequence[RecoveredField[TermSyntax]],
...
class ZantufaForethoughtTermsetBranchSyntax:
    ...
    def __new__(
        cls,
        gik: RecoveredField[ZantufaExtraGikConnectiveSyntax],
        terms: Sequence[RecoveredField[TermSyntax]],
        nuhu: WithFreeModifiers[RecoveredField[Token], RecoveredField[FreeModifierSyntax]] | None,
...
class SumtiAssociationRelativeClauseSyntax:
    ...
    def __new__(
        ...
        sumti: RecoveredField[RelativeSumtiSyntax],
...
class ConnectedLinkedTermContinuationSyntax:
    ...
    def __new__(cls, connective: RecoveredField[ConnectedTermConnectiveSyntax], trailing_link: RecoveredField[BoundLinkedTermSyntax]) -> ConnectedLinkedTermContinuationSyntax: ...
    @property
    def connective(self) -> RecoveredField[ConnectedTermConnectiveSyntax]:
