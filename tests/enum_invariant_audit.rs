...
const ALLOWED_PLACEHOLDERS: &[(&str, &str)] = &[
    ...
    (
        "crates/jbotci-web-core/src/lib.rs:VlackuInline::Text",
        "inline text parts are generated by the vlacku markup splitter and have no independent semantic contract",
    ),
    (
        "crates/jbotci-web-core/src/lib.rs:VlackuInline::WordRef",
        "inline word references are generated from dictionary markup and route serialization helpers",
    ),
    (
        "crates/jbotci-web-core/src/lib.rs:VlackuInline::Place",
        "inline place labels are generated from the shared sumti-place formatter",
    ),
    (
