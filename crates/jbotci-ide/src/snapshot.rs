...
mod tests {
    ...
    fn lujvo_hover_snapshots_morphology_decomposition_and_component_cards() {
        ...
        assert_eq!(
            ...
            concat!(
                ...
                "---\n\n",
                "### `sutra` — *gismu*\n\n",
                "𝑥₁ is fast/swift/quick/hastes/rapid at doing/being/bringing about 𝑥₂ ",
                "(event/state).\n\n",
    ...
    fn attested_zei_compound_hover_prefers_the_compound_card() {
        ...
        assert_eq!(
            ...
            concat!(
                ...
                "𝑥₁ is an open/low central unrounded vowel sound produced by 𝑥₂.\n\n",
    ...
    fn fuhivla_and_cmevla_hovers_follow_dictionary_boundary() {
        ...
        assert_eq!(
            ...
            concat!(
                "### `djarspageti` — *fu'ivla*\n\n",
                "𝑥₁ is a quantity of spaghetti (long, thin cylindrical pasta).\n\n",
                "**Glosses:** `spaghetti`",
            ),
        );
    ...
    fn minu_hovers_have_no_unattested_sequence_section() {
        ...
        assert_eq!(
            ...
            concat!(
                "### `nu` — *cmavo* · **NU**\n\n",
                "abstractor: generalized event abstractor; 𝑥₁ is ",
