...
#[invariant(::DelimitedWordQuote(zohoi) => zohoi.quote_marker_cmavo().is_some_and(|cmavo| [Cmavo::Zohoi, Cmavo::Lahoi, Cmavo::Rahoi, Cmavo::Mehoi, Cmavo::Gohoi, Cmavo::Zehoi, Cmavo::Tahai, Cmavo::Bohei].contains(&cmavo)))]
...
#[invariant(::QuotedBridiSelbri(gohoi) => gohoi.quote_marker_cmavo().is_some_and(|cmavo| [Cmavo::Gohoi, Cmavo::Zehoi, Cmavo::Tahai, Cmavo::Bohei].contains(&cmavo)))]
