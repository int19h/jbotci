...
fn sourced_owner_takes_simple_term_extent(operand: &SimpleTermSyntax) -> bool {
    match operand {
        ...
        | SimpleTermSyntax::FihoiProposalAdverbialTerm(_)
        | SimpleTermSyntax::ZantufaXoiAdverbialTerm(_)
        | SimpleTermSyntax::ExpSoiAdverbialTerm(_)
...
fn sourced_owner_takes_normal_term_extent(operand: &NormalTermAtomSyntax) -> bool {
    match operand {
        ...
        | NormalTermAtomSyntax::FihoiProposalAdverbialTerm(_)
        | NormalTermAtomSyntax::ZantufaXoiAdverbialTerm(_)
        | NormalTermAtomSyntax::ExpSoiAdverbialTerm(_)
...
fn recovered_sourced_owner_takes_simple_term_extent(operand: &recovered::SimpleTermSyntax) -> bool {
    match operand {
        ...
        | recovered::SimpleTermSyntax::FihoiProposalAdverbialTerm(_)
        | recovered::SimpleTermSyntax::ZantufaXoiAdverbialTerm(_)
        | recovered::SimpleTermSyntax::ExpSoiAdverbialTerm(_)
...
fn recovered_sourced_owner_takes_normal_term_extent(
    ...
    match operand {
        ...
        | recovered::NormalTermAtomSyntax::FihoiProposalAdverbialTerm(_)
        | recovered::NormalTermAtomSyntax::ZantufaXoiAdverbialTerm(_)
        | recovered::NormalTermAtomSyntax::ExpSoiAdverbialTerm(_)
