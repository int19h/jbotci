...
#[requires(true)]
#[ensures(ret.as_ref().is_ok_and(|text| text.is_empty() == generated_text_is_empty(tree)) || ret.is_err())]
...
#[requires(true)]
#[ensures(ret.as_ref().is_ok_and(|fragments| fragments.is_empty() == generated_text_is_empty(tree)) || ret.is_err())]
