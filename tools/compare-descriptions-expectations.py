...
if __package__:
    from .rust_debug import DebugParseError, DebugParser, Form
else:
    # Also support importlib-based tests launched from the repository root.
    try:
        from tools.rust_debug import DebugParseError, DebugParser, Form
